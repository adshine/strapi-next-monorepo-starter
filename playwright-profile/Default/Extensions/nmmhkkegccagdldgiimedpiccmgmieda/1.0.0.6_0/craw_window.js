...
m.exportPath_ = function (a, c, d, e) {
  a = a.split(".")
  e = e || m.global
  a[0] in e || "undefined" == typeof e.execScript || e.execScript("var " + a[0])
...
m.loadFileSync_ = function (a) {
  if (m.global.CLOSURE_LOAD_FILE_SYNC) return m.global.CLOSURE_LOAD_FILE_SYNC(a)
  try {
...
m.string.internal.caseInsensitiveStartsWith = function (a, c) {
  return 0 == m.string.internal.caseInsensitiveCompare(c, a.substr(0, c.length))
}
...
m.debug.enhanceError = function (a, c) {
  a instanceof Error ||
    ((a = Error(a)),
    Error.captureStackTrace && Error.captureStackTrace(a, m.debug.enhanceError))
...
m.Timer.callOnce = function (a, c, d) {
  ...
  else if (a && "function" == typeof a.handleEvent) a = m.bind(a.handleEvent, a)
