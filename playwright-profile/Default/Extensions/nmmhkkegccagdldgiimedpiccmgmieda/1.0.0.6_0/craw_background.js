...
e.defineProperty =
  e.ASSUME_ES5 || "function" == typeof Object.defineProperties
...
e.polyfill = function (a, b, c) {
  b &&
    (e.ISOLATE_POLYFILLS
      ? e.polyfillIsolated(a, b, c)
      : e.polyfillUnisolated(a, b))
}
e.polyfillUnisolated = function (a, b) {
  ...
  b != f &&
    null != b &&
    e.defineProperty(c, a, { configurable: !0, writable: !0, value: b })
}
...
e.objectCreate =
  e.ASSUME_ES5 || "function" == typeof Object.create
    ? Object.create
    : function (a) {
        var b = function () {}
        b.prototype = a
...
e.setPrototypeOf =
  e.TRUST_ES6_POLYFILLS && "function" == typeof Object.setPrototypeOf
...
e.findInternal = function (a, b, c) {
  ...
  for (var f = a.length, g = 0; g < f; g++) {
    var h = a[g]
    if (b.call(c, h, g, a)) return { i: g, v: h }
  }
  return { i: -1, v: void 0 }
}
    ...
    return a
      ...
      : function (b, c) {
          ...
          var g = f.length,
            h = b.length
          c = Math.max(0, Math.min(c | 0, f.length))
          for (var l = 0; l < h && c < g; ) if (f[c++] != b[l++]) return !1
          return l >= h
        }
  },
  "es6"
  ...
  function (a) {
    return a
      ...
      : function (b) {
          ...
          b |= 0
          for (var f = ""; b; ) if ((b & 1 && (f += c), (b >>>= 1))) c += c
          return f
        }
  },
  "es6"
...
k.getScriptNonce = function (a) {
  ...
  null === k.cspNonce_ && (k.cspNonce_ = k.getScriptNonce_(k.global.document))
  return k.cspNonce_
}
...
k.isInGoogModuleLoader_ = function () {
  return (
    !!k.moduleLoaderState_ && k.moduleLoaderState_.type == k.ModuleType.GOOG
  )
}
...
k.loadFileSync_ = function (a) {
  if (k.global.CLOSURE_LOAD_FILE_SYNC) return k.global.CLOSURE_LOAD_FILE_SYNC(a)
  try {
...
k.getUid = function (a) {
  return (
    (Object.prototype.hasOwnProperty.call(a, k.UID_PROPERTY_) &&
      a[k.UID_PROPERTY_]) ||
...
k.getCssName = function (a, b) {
  ...
  f = k.cssNameMapping_
    ? "BY_WHOLE" == k.cssNameMappingStyle_
      ? c
      : f
    : function (g) {
        return g
  ...
  a = b ? a + "-" + f(b) : f(a)
  return k.global.CLOSURE_CSS_NAME_MAP_FN
    ? k.global.CLOSURE_CSS_NAME_MAP_FN(a)
    : a
}
...
k.defineClass = function (a, b) {
  ...
  null != f &&
    (f instanceof Function ? f(c) : k.defineClass.applyProperties_(c, f))
  return c
}
...
var n =
  k.NATIVE_ARRAY_PROTOTYPES && (m || Array.prototype.forEach)
    ...
    : function (a, b, c) {
        for (
          var f = a.length, g = "string" === typeof a ? a.split("") : a, h = 0;
          h < f;
          h++
        )
...
function ta(a, b, c) {
  var f = a.length,
    g = "string" === typeof a ? a.split("") : a
  for (--f; 0 <= f; f--) if (f in g && b.call(c, g[f], f, a)) return f
  return -1
}
...
k.array.equals = function (a, b) {
  if (!k.isArrayLike(a) || !k.isArrayLike(b) || a.length != b.length) return !1
...
function Na(a, b, c) {
  ...
  void 0 !== b && ((g = a), (h = b))
  if (0 > c * (h - g)) return []
  if (0 < c) for (a = g; a < h; a += c) f.push(a)
  else for (a = g; a > h; a += c) f.push(a)
  return f
}
k.array.range = Na
function Oa(a, b) {
...
k.debug.errorcontext.addErrorContext = function (a, b, c) {
  a[k.debug.errorcontext.CONTEXT_KEY_] ||
    (a[k.debug.errorcontext.CONTEXT_KEY_] = {})
...
k.string.internal.caseInsensitiveStartsWith = function (a, b) {
  return 0 == k.string.internal.caseInsensitiveCompare(b, a.substr(0, b.length))
}
k.string.internal.caseInsensitiveEndsWith = function (a, b) {
  return (
    0 ==
    k.string.internal.caseInsensitiveCompare(
      b,
...
k.string.internal.htmlEscape = function (a, b) {
  if (b)
    ...
    if (!k.string.internal.ALL_RE_.test(a)) return a
    ;-1 != a.indexOf("&") && (a = a.replace(k.string.internal.AMP_RE_, "&amp;"))
    ;-1 != a.indexOf("<") && (a = a.replace(k.string.internal.LT_RE_, "&lt;"))
    ;-1 != a.indexOf(">") && (a = a.replace(k.string.internal.GT_RE_, "&gt;"))
    ;-1 != a.indexOf('"') &&
      (a = a.replace(k.string.internal.QUOT_RE_, "&quot;"))
    ;-1 != a.indexOf("'") &&
      (a = a.replace(k.string.internal.SINGLE_QUOTE_RE_, "&#39;"))
    ;-1 != a.indexOf("\x00") &&
      (a = a.replace(k.string.internal.NULL_RE_, "&#0;"))
  }
  return a
}
...
k.string.internal.whitespaceEscape = function (a) {
  return k.string.internal.newLineToBr(a.replace(/  /g, " &#160;"), void 0)
}
...
k.string.internal.compareVersions = function (a, b) {
  ...
  for (var f = Math.max(a.length, b.length), g = 0; 0 == c && g < f; g++) {
    var h = a[g] || "",
      l = b[g] || ""
    do {
      h = /(\d*)(\D*)(.*)/.exec(h) || ["", "", "", ""]
...
k.labs.userAgent.util.userAgent_ =
  k.labs.userAgent.util.getNativeUserAgentString_()
k.labs.userAgent.util.setUserAgent = function (a) {
  k.labs.userAgent.util.userAgent_ =
    a || k.labs.userAgent.util.getNativeUserAgentString_()
}
...
k.labs.userAgent.util.matchUserAgentIgnoreCase = function (a) {
  return k.string.internal.caseInsensitiveContains(
    k.labs.userAgent.util.getUserAgent(),
    a
  )
}
...
k.object.equals = function (a, b) {
  ...
  for (var f in b) if (!(f in a)) return !1
  return !0
}
...
k.object.extend = function (a, b) {
  for (var c, f, g = 1; g < arguments.length; g++) {
    f = arguments[g]
    for (c in f) a[c] = f[c]
    for (var h = 0; h < k.object.PROTOTYPE_FIELDS_.length; h++)
...
k.object.getAllPropertyNames = function (a, b, c) {
  ...
  for (
    ...
    for (var g = Object.getOwnPropertyNames(a), h = 0; h < g.length; h++)
      f[g[h]] = !0
...
k.labs.userAgent.browser.matchIE_ = function () {
  return (
    k.labs.userAgent.util.matchUserAgent("Trident") ||
    k.labs.userAgent.util.matchUserAgent("MSIE")
  )
}
...
k.labs.userAgent.browser.matchFirefox_ = function () {
  return (
    k.labs.userAgent.util.matchUserAgent("Firefox") ||
    k.labs.userAgent.util.matchUserAgent("FxiOS")
  )
}
...
k.labs.userAgent.browser.isEdgeChromium =
  k.labs.userAgent.browser.matchEdgeChromium_
k.labs.userAgent.browser.isOperaChromium =
  k.labs.userAgent.browser.matchOperaChromium_
...
k.labs.userAgent.browser.isVersionOrHigher = function (a) {
  return (
    0 <=
    k.string.internal.compareVersions(k.labs.userAgent.browser.getVersion(), a)
  )
}
...
k.functions.and = function (a) {
  var b = arguments,
    c = b.length
  return function () {
    for (var f = 0; f < c; f++) if (!b[f].apply(this, arguments)) return !1
    return !0
  }
}
k.functions.or = function (a) {
  var b = arguments,
    c = b.length
  return function () {
    for (var f = 0; f < c; f++) if (b[f].apply(this, arguments)) return !0
    return !1
  }
}
...
k.i18n.bidi.IS_RTL =
  ...
  (("ar" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "fa" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "he" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "iw" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "ps" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "sd" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "ug" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "ur" == k.LOCALE.substring(0, 2).toLowerCase() ||
    "yi" == k.LOCALE.substring(0, 2).toLowerCase()) &&
    (2 == k.LOCALE.length ||
      "-" == k.LOCALE.substring(2, 3) ||
      "_" == k.LOCALE.substring(2, 3))) ||
  (3 <= k.LOCALE.length &&
    "ckb" == k.LOCALE.substring(0, 3).toLowerCase() &&
    (3 == k.LOCALE.length ||
      "-" == k.LOCALE.substring(3, 4) ||
      "_" == k.LOCALE.substring(3, 4))) ||
  (7 <= k.LOCALE.length &&
    ("-" == k.LOCALE.substring(2, 3) || "_" == k.LOCALE.substring(2, 3)) &&
    ("adlm" == k.LOCALE.substring(3, 7).toLowerCase() ||
      "arab" == k.LOCALE.substring(3, 7).toLowerCase() ||
      "hebr" == k.LOCALE.substring(3, 7).toLowerCase() ||
      "nkoo" == k.LOCALE.substring(3, 7).toLowerCase() ||
      "rohg" == k.LOCALE.substring(3, 7).toLowerCase() ||
      "thaa" == k.LOCALE.substring(3, 7).toLowerCase())) ||
  (8 <= k.LOCALE.length &&
    ("-" == k.LOCALE.substring(3, 4) || "_" == k.LOCALE.substring(3, 4)) &&
    ("adlm" == k.LOCALE.substring(4, 8).toLowerCase() ||
      "arab" == k.LOCALE.substring(4, 8).toLowerCase() ||
      "hebr" == k.LOCALE.substring(4, 8).toLowerCase() ||
      "nkoo" == k.LOCALE.substring(4, 8).toLowerCase() ||
      "rohg" == k.LOCALE.substring(4, 8).toLowerCase() ||
      "thaa" == k.LOCALE.substring(4, 8).toLowerCase()))
k.i18n.bidi.Format = {
  LRE: "\u202a",
  RLE: "\u202b",
  PDF: "\u202c",
...
k.i18n.bidi.I18N_RIGHT = k.i18n.bidi.IS_RTL
  ? k.i18n.bidi.LEFT
  : k.i18n.bidi.RIGHT
k.i18n.bidi.I18N_LEFT = k.i18n.bidi.IS_RTL
  ? k.i18n.bidi.RIGHT
  : k.i18n.bidi.LEFT
...
k.i18n.bidi.isNeutralText = function (a, b) {
  ...
  return (
    k.i18n.bidi.isRequiredLtrRe_.test(a) ||
    (!k.i18n.bidi.hasAnyLtr(a) && !k.i18n.bidi.hasAnyRtl(a))
  )
}
...
k.i18n.bidi.endsWithLtr = function (a, b) {
  return k.i18n.bidi.ltrExitDirCheckRe_.test(
    k.i18n.bidi.stripHtmlIfNeeded_(a, b)
  )
}
k.i18n.bidi.isLtrExitText = k.i18n.bidi.endsWithLtr
k.i18n.bidi.endsWithRtl = function (a, b) {
  return k.i18n.bidi.rtlExitDirCheckRe_.test(
    k.i18n.bidi.stripHtmlIfNeeded_(a, b)
  )
}
...
k.i18n.bidi.setElementDirAndAlign = function (a, b) {
  a &&
    ...
    ((a.style.textAlign =
      b == k.i18n.bidi.Dir.RTL ? k.i18n.bidi.RIGHT : k.i18n.bidi.LEFT),
...
k.html.TrustedResourceUrl.unwrapTrustedScriptURL = function (a) {
  if (
    a instanceof k.html.TrustedResourceUrl &&
    a.constructor === k.html.TrustedResourceUrl
  )
...
k.html.TrustedResourceUrl.format = function (a, b) {
  ...
  a = c.replace(k.html.TrustedResourceUrl.FORMAT_MARKER_, function (f, g) {
    ...
    f = b[g]
    return f instanceof k.string.Const
      ? k.string.Const.unwrap(f)
...
k.html.TrustedResourceUrl.fromConstants = function (a) {
  for (var b = "", c = 0; c < a.length; c++) b += k.string.Const.unwrap(a[c])
  return k.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(
    b
  )
}
...
k.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse =
  function (a) {
    var b = k.html.trustedtypes.getPolicyPrivateDoNotAccessOrElse()
    a = b ? b.createScriptURL(a) : a
    return new k.html.TrustedResourceUrl(
      a,
      k.html.TrustedResourceUrl.CONSTRUCTOR_TOKEN_PRIVATE_
    )
  }
...
k.html.SafeUrl.unwrap = function (a) {
  ...
  k.asserts.fail(
    "expected object of type SafeUrl, got '" + a + "' of type " + k.typeOf(a)
  )
...
k.html.SafeUrl.fromTelUrl = function (a) {
  k.string.internal.caseInsensitiveStartsWith(a, "tel:") ||
...
k.html.SafeUrl.fromSipUrl = function (a) {
  k.html.SIP_URL_PATTERN_.test(decodeURIComponent(a)) ||
    (a = k.html.SafeUrl.INNOCUOUS_STRING)
  return k.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
}
...
k.html.SafeUrl.fromSshUrl = function (a) {
  k.string.internal.caseInsensitiveStartsWith(a, "ssh://") ||
    (a = k.html.SafeUrl.INNOCUOUS_STRING)
  return k.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a)
}
  ...
  ;(a = a.exec(b))
    ? ((a = a[1]),
      -1 ==
        ...
        ).indexOf(a) && (b = k.html.SafeUrl.INNOCUOUS_STRING))
...
k.html.SafeUrl.sanitizeAssertUnchanged = function (a, b) {
  ...
  if (
    ...
    return b
  k.asserts.assert(
    k.html.SAFE_URL_PATTERN_.test(a),
...
k.html.SafeUrl.INNOCUOUS_URL =
  k.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(
    k.html.SafeUrl.INNOCUOUS_STRING
  )
...
k.html.SafeStyle.unwrap = function (a) {
  ...
  k.asserts.fail(
    "expected object of type SafeStyle, got '" + a + "' of type " + k.typeOf(a)
  )
...
k.html.SafeStyle.EMPTY =
  k.html.SafeStyle.createSafeStyleSecurityPrivateDoNotAccessOrElse("")
...
k.html.SafeStyle.sanitizePropertyValue_ = function (a) {
  if (a instanceof k.html.SafeUrl)
    return (
      'url("' +
      k.html.SafeUrl.unwrap(a).replace(/</g, "%3c").replace(/[\\"]/g, "\\$&") +
      '")'
    )
  a =
    a instanceof k.string.Const
  ...
  if (/[{;}]/.test(a))
    throw new k.asserts.AssertionError("Value does not allow [{;}], got: %s.", [
      a,
    ])
  return a
}
...
k.html.SafeStyle.VALUE_RE_ = new RegExp(
  "^" + k.html.SafeStyle.VALUE_ALLOWED_CHARS_ + "+$"
)
...
k.html.SafeStyle.FUNCTIONS_RE_ = new RegExp(
  "\\b(" +
    k.html.SafeStyle.ALLOWED_FUNCTIONS_.join("|") +
    ")\\([-+*/0-9a-z.%\\[\\], ]+\\)",
  "g"
)
...
k.html.SafeHtml.unwrapTrustedHTML = function (a) {
  ...
  k.asserts.fail(
    "expected object of type SafeHtml, got '" + a + "' of type " + k.typeOf(a)
  )
...
k.html.SafeHtml.createScript = function (a, b) {
  ...
  a = k.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(
    c,
    k.i18n.bidi.Dir.NEUTRAL
  )
  return k.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(
...
k.html.SafeHtml.getAttrNameAndValue_ = function (a, b, c) {
  if (c instanceof k.string.Const) c = k.string.Const.unwrap(c)
    ...
    if (b.toLowerCase() in k.html.SafeHtml.URL_ATTRIBUTES_)
      ...
      else if (c instanceof k.html.SafeUrl) c = k.html.SafeUrl.unwrap(c)
...
k.html.SafeHtml.concat = function (a) {
  return k.html.SafeHtml.join(
    k.html.SafeHtml.EMPTY,
...
k.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse = function (
  a,
  b
) {
...
k.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function (
  a,
  b,
  c
) {
  ...
  k.dom.tags.isVoidTag(a.toLowerCase())
    ...
    : ((f = k.html.SafeHtml.concat(c)),
      ...
      (f = f.getDirection()))
  ;(a = b && b.dir) &&
    (f = /^(ltr|rtl|auto)$/i.test(a) ? k.i18n.bidi.Dir.NEUTRAL : null)
  ...
  if (b)
    for (var f in b)
      if (Object.prototype.hasOwnProperty.call(b, f)) {
        ...
        var g = b[f]
        null != g && (c += " " + k.html.SafeHtml.getAttrNameAndValue_(a, f, g))
      }
  return c
}
k.html.SafeHtml.combineAttributes = function (a, b, c) {
  ...
  for (g in a)
    Object.prototype.hasOwnProperty.call(a, g) &&
      (k.asserts.assert(g.toLowerCase() == g, "Must be lower case"),
      (f[g] = a[g]))
  for (g in b)
...
k.html.uncheckedconversions.trustedResourceUrlFromStringKnownToSatisfyTypeContract =
  function (a, b) {
    k.asserts.assertString(
      k.string.Const.unwrap(a),
      "must provide justification"
...
k.dom.safe.setNonceForScriptElement_ = function (a) {
  var b = k.getScriptNonce(a.ownerDocument && a.ownerDocument.defaultView)
...
k.dom.safe.openInWindow = function (a, b, c, f, g) {
  a =
    a instanceof k.html.SafeUrl ? a : k.html.SafeUrl.sanitizeAssertUnchanged(a)
  b = b || k.global
...
k.string.numberAwareCompare_ = function (a, b, c) {
  ...
  for (
    ...
    if (c != r)
      return (
        (a = parseInt(c, 10)),
        !isNaN(a) && ((b = parseInt(r, 10)), !isNaN(b) && a - b)
          ? a - b
          : c < r
            ? -1
            : 1
...
k.string.unescapeEntitiesWithDocument = function (a, b) {
  return k.string.contains(a, "&")
    ? k.string.unescapeEntitiesUsingDom_(a, b)
    : a
}
k.string.unescapeEntitiesUsingDom_ = function (a, b) {
  var c = { "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"' }
  var f = b ? b.createElement("div") : k.global.document.createElement("div")
  return a.replace(k.string.HTML_ENTITY_PATTERN_, function (g, h) {
    var l = c[g]
    if (l) return l
    "#" == h.charAt(0) &&
      ((h = Number("0" + h.substr(1))),
      isNaN(h) || (l = String.fromCharCode(h)))
    l ||
      (k.dom.safe.setInnerHtml(
        f,
        k.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(
...
k.string.truncateMiddle = function (a, b, c, f) {
  ...
  f && a.length > b
    ? (f > b && (f = b),
      (a = a.substring(0, b - f) + "..." + a.substring(a.length - f)))
    : a.length > b &&
      ((f = Math.floor(b / 2)),
...
k.string.quote = function (a) {
  ...
  for (var b = ['"'], c = 0; c < a.length; c++) {
    var f = a.charAt(c),
      g = f.charCodeAt(0)
    b[c + 1] =
      k.string.specialEscapeChars_[f] ||
      (31 < g && 127 > g ? f : k.string.escapeChar(f))
  }
  b.push('"')
  return b.join("")
}
...
k.string.removeAt = function (a, b, c) {
  ...
  0 <= b &&
    b < a.length &&
    0 < c &&
    (f = a.substr(0, b) + a.substr(b + c, a.length - b - c))
  return f
}
...
k.labs.userAgent.engine.isWebKit = function () {
  return (
    k.labs.userAgent.util.matchUserAgentIgnoreCase("WebKit") &&
...
k.labs.userAgent.engine.getVersion = function () {
  ...
  if (a) {
    ...
    if (b)
      return "Gecko" == b[0]
        ? k.labs.userAgent.engine.getVersionForKey_(a)
        : b[1]
    a = a[0]
    var c
...
k.labs.userAgent.engine.isVersionOrHigher = function (a) {
  return 0 <= k.string.compareVersions(k.labs.userAgent.engine.getVersion(), a)
}
...
k.labs.userAgent.platform.isVersionOrHigher = function (a) {
  return (
    0 <= k.string.compareVersions(k.labs.userAgent.platform.getVersion(), a)
  )
}
k.reflect = {}
...
k.userAgent.isLegacyLinux_ = function () {
  return (
    k.labs.userAgent.platform.isLinux() ||
    k.labs.userAgent.platform.isChromeOS()
  )
}
...
k.userAgent.X11 = k.userAgent.PLATFORM_KNOWN_
  ? k.userAgent.ASSUME_X11
  : k.userAgent.isX11_()
...
k.userAgent.determineVersion_ = function () {
  ...
  return k.userAgent.IE &&
    ((b = k.userAgent.getDocumentMode_()), null != b && b > parseFloat(a))
    ? String(b)
    : a
}
    ...
    h = function (l, r) {
      ...
      try {
        if (void 0 === l) c.push("undefined")
          ...
          k.hasUid(l) || f.push(l)
          var E = k.getUid(l)
          if (g[E]) c.push("*** reference loop detected (id=" + E + ") ***")
          else {
            g[E] = !0
            c.push("{")
            for (var H in l)
...
k.debug.normalizeErrorObject = function (a) {
  ...
  try {
    var g =
      a.fileName || a.filename || a.sourceURL || k.global.$googDebugFname || b
  } catch (l) {
    ;(g = "Not available"), (c = !0)
  }
  ...
  if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
    ...
    if (null == c) {
      if (a.constructor && a.constructor instanceof Function) {
        var h = a.constructor.name
          ? a.constructor.name
          : k.debug.getFunctionName(a.constructor)
        c = 'Unknown Error of type "' + h + '"'
        if (k.debug.CHECK_FOR_THROWN_EVENT && "Event" == h)
          try {
...
k.debug.enhanceError = function (a, b) {
  a instanceof Error ||
    ((a = Error(a)),
    Error.captureStackTrace && Error.captureStackTrace(a, k.debug.enhanceError))
...
k.debug.enhanceErrorWithContext = function (a, b) {
  ...
  if (b) for (var c in b) k.debug.errorcontext.addErrorContext(a, c, b[c])
  return a
}
...
k.debug.getStacktrace = function (a) {
  var b
  k.debug.FORCE_SLOPPY_STACKS ||
    (b = k.debug.getNativeStackTrace_(a || k.debug.getStacktrace))
...
k.debug.entryPointRegistry.register = function (a) {
  k.debug.entryPointRegistry.refList_[
    k.debug.entryPointRegistry.refList_.length
  ] = a
  if (k.debug.entryPointRegistry.monitorsMayExist_)
    for (var b = k.debug.entryPointRegistry.monitors_, c = 0; c < b.length; c++)
      a(k.bind(b[c].wrap, b[c]))
}
k.debug.entryPointRegistry.monitorAll = function (a) {
  k.debug.entryPointRegistry.monitorsMayExist_ = !0
  for (
    var b = k.bind(a.wrap, a), c = 0;
    c < k.debug.entryPointRegistry.refList_.length;
    c++
  )
...
k.debug.entryPointRegistry.unmonitorAllIfPossible = function (a) {
  ...
  a = k.bind(a.unwrap, a)
  for (var c = 0; c < k.debug.entryPointRegistry.refList_.length; c++)
...
k.Disposable.getUndisposedObjects = function () {
  ...
  for (b in k.Disposable.instances_)
    k.Disposable.instances_.hasOwnProperty(b) &&
      a.push(k.Disposable.instances_[Number(b)])
  return a
}
...
k.events.BrowserFeature = {
  ...
  TOUCH_ENABLED:
    ...
    !(
      !k.global.navigator ||
      (!k.global.navigator.maxTouchPoints &&
        !k.global.navigator.msMaxTouchPoints)
    ),
  POINTER_EVENTS: "PointerEvent" in k.global,
  MSPOINTER_EVENTS:
    "MSPointerEvent" in k.global &&
    !(!k.global.navigator || !k.global.navigator.msPointerEnabled),
  PASSIVE_EVENTS: (function () {
    if (!k.global.addEventListener || !Object.defineProperty) return !1
    var a = !1,
  ...
  if (a) {
    ...
    f
      ...
      : (k.events.USE_LAYER_XY_AS_OFFSET_XY
          ...
          : ((this.offsetX =
              k.userAgent.WEBKIT || void 0 !== a.offsetX
                ? a.offsetX
                : a.layerX),
            (this.offsetY =
              k.userAgent.WEBKIT || void 0 !== a.offsetY
                ? a.offsetY
                : a.layerY)),
...
k.events.BrowserEvent.prototype.preventDefault = function () {
  ...
  if (a.preventDefault) a.preventDefault()
    ...
    ((a.returnValue = !1),
    k.events.BrowserFeature.SET_KEY_CODE_TO_PREVENT_DEFAULT)
  )
    try {
...
k.events.Listenable.IMPLEMENTED_BY_PROP =
...
k.events.ListenerMap.prototype.add = function (a, b, c, f, g) {
  ...
  var l = k.events.ListenerMap.findListenerIndex_(a, b, f, g)
  ;-1 < l
    ? ((b = a[l]), c || (b.callOnce = !1))
    : ((b = new k.events.Listener(b, this.src, h, !!f, g)),
      (b.callOnce = c),
      a.push(b))
  return b
}
k.events.ListenerMap.prototype.remove = function (a, b, c, f) {
  ...
  return -1 < b
    ? (Ya(g[b]),
      Ba(g, b),
      0 == g.length && (delete this.listeners[a], this.typeCount_--),
      !0)
    : !1
}
var Za = function (a, b) {
  ...
  f &&
    (Ya(b),
    0 == a.listeners[c].length && (delete a.listeners[c], a.typeCount_--))
  return f
}
k.events.ListenerMap.prototype.removeAll = function (a) {
  ...
  for (c in this.listeners)
    if (!a || c == a) {
      for (var f = this.listeners[c], g = 0; g < f.length; g++) ++b, Ya(f[g])
...
k.events.ListenerMap.prototype.hasListener = function (a, b) {
  ...
  return k.object.some(this.listeners, function (h) {
    for (var l = 0; l < h.length; ++l)
      if (!((c && h[l].type != f) || (g && h[l].capture != b))) return !0
    return !1
  })
}
...
k.events.listen = function (a, b, c, f, g) {
  ...
  if (Array.isArray(b)) {
    for (var h = 0; h < b.length; h++) k.events.listen(a, b[h], c, f, g)
    return null
  }
...
k.events.listen_ = function (a, b, c, f, g, h) {
  ...
  if (l && !k.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    if (
      k.events.CAPTURE_SIMULATION_MODE ==
      k.events.CaptureSimulationMode.OFF_AND_FAIL
    )
      return k.asserts.fail("Can not register capture listener in IE8-."), null
    if (
      k.events.CAPTURE_SIMULATION_MODE ==
      k.events.CaptureSimulationMode.OFF_AND_SILENT
    )
      return null
  }
  ...
  else if (a.attachEvent) a.attachEvent(k.events.getOnString_(b.toString()), f)
  else if (a.addListener && a.removeListener)
    k.asserts.assert("change" === b, "MediaQueryList only has a change event"),
      a.addListener(f)
...
k.events.listenOnce = function (a, b, c, f, g) {
  if (Array.isArray(b)) {
    for (var h = 0; h < b.length; h++) k.events.listenOnce(a, b[h], c, f, g)
    return null
  }
  c = k.events.wrapListener(c)
  return k.events.Listenable.isImplementedBy(a)
...
k.events.unlisten = function (a, b, c, f, g) {
  if (Array.isArray(b)) {
    for (var h = 0; h < b.length; h++) k.events.unlisten(a, b[h], c, f, g)
    return null
  }
  f = k.isObject(f) ? !!f.capture : !!f
  c = k.events.wrapListener(c)
  if (k.events.Listenable.isImplementedBy(a)) return a.unlisten(b, c, f, g)
  if (!a) return !1
...
k.events.unlistenByKey = function (a) {
  ...
  ;(c = k.events.getListenerMap_(b))
    ? (Za(c, a),
      0 == c.typeCount_ &&
        ((c.src = null), (b[k.events.LISTENER_MAP_PROP_] = null)))
    : Ya(a)
  return !0
}
...
k.events.removeAll = function (a, b) {
  if (!a) return 0
  if (k.events.Listenable.isImplementedBy(a)) return a.removeAllListeners(b)
...
k.events.protectBrowserEventEntryPoint = function (a) {
  k.events.handleBrowserEvent_ = a.protectEntryPoint(
    k.events.handleBrowserEvent_
  )
}
  ...
  if (!k.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
    ...
    if (k.events.CAPTURE_SIMULATION_MODE == k.events.CaptureSimulationMode.ON) {
      if (!k.events.isMarkedIeEvent_(c)) {
        ...
        c = []
        for (var g = b.currentTarget; g; g = g.parentNode) c.push(g)
        a = a.type
        for (g = c.length - 1; !b.propagationStopped_ && 0 <= g; g--) {
          b.currentTarget = c[g]
        ...
        for (g = 0; !b.propagationStopped_ && g < c.length; g++)
          (b.currentTarget = c[g]),
            (h = k.events.fireListeners_(c[g], a, !1, b)),
            (f = f && h)
      }
...
k.events.LISTENER_WRAPPER_PROP_ =
...
d.dispatchEvent = function (a) {
  ...
  if (b) {
    var c = []
    for (var f = 1; b; b = b.getParentEventTarget())
      c.push(b),
        k.asserts.assert(
          ++f < k.events.EventTarget.MAX_ANCESTORS_,
          "infinite loop"
        )
  }
  return k.events.EventTarget.dispatchEventInternal_(
...
k.iter.StopIteration =
  "StopIteration" in k.global
    ? k.global.StopIteration
...
k.iter.range = function (a, b, c) {
  ...
  l.next = function () {
    if ((0 < h && f >= g) || (0 > h && f <= g)) throw k.iter.StopIteration
    var r = f
    f += h
    return r
  }
...
k.iter.permutations = function (a, b) {
  a = k.iter.toArray(a)
  b = k.iter.product.apply(void 0, Oa(a, "number" === typeof b ? b : a.length))
...
d.containsValue = function (a) {
  for (var b = 0; b < this.keys_.length; b++) {
    var c = this.keys_[b]
    if (k.structs.Map.hasKey_(this.map_, c) && this.map_[c] == a) return !0
  }
  return !1
}
...
var bb = function (a) {
  ...
  if (a.count_ != a.keys_.length) {
    ...
    for (c = b = 0; b < a.keys_.length; )
      (f = a.keys_[b]),
        k.structs.Map.hasKey_(g, f) || ((a.keys_[c++] = f), (g[f] = 1)),
        b++
    a.keys_.length = c
  }
}
...
d.set = function (a, b) {
  k.structs.Map.hasKey_(this.map_, a) ||
...
d.set = function (a, b) {
  ...
  c
    ? (c.value = b)
    : ((c = new k.structs.LinkedMap.Node_(a, b)),
      this.map_.set(a, c),
      cb(this, c))
}
d.peek = function () {
...
k.structs.getCount = function (a) {
  return a.getCount && "function" == typeof a.getCount
    ? a.getCount()
    : k.isArrayLike(a) || "string" === typeof a
      ? a.length
      : k.object.getCount(a)
}
...
k.structs.filter = function (a, b, c) {
  ...
  if (f) {
    var l = {}
    for (var r = 0; r < h; r++) b.call(c, g[r], f[r], a) && (l[f[r]] = g[r])
  } else
    for (l = [], r = 0; r < h; r++) b.call(c, g[r], void 0, a) && l.push(g[r])
  return l
}
k.structs.map = function (a, b, c) {
  ...
  } else for (l = [], r = 0; r < h; r++) l[r] = b.call(c, g[r], void 0, a)
  return l
}
  ...
  k.uri.utils.urlPackageSupportLoggingHandler_ &&
    0 <=
      ["http", "https", "ws", "wss", "ftp"].indexOf(
        b[k.uri.utils.ComponentIndex.SCHEME]
      ) &&
    k.uri.utils.urlPackageSupportLoggingHandler_(a)
  return b
}
...
k.uri.utils.getUserInfoEncoded = function () {
  return k.uri.utils.getComponentByIndex_(
    k.uri.utils.ComponentIndex.USER_INFO,
    void 0
  )
}
...
k.uri.utils.getDomainEncoded = function () {
  return k.uri.utils.getComponentByIndex_(
    k.uri.utils.ComponentIndex.DOMAIN,
    void 0
  )
}
...
k.uri.utils.getPort = function () {
  return (
    Number(
      k.uri.utils.getComponentByIndex_(k.uri.utils.ComponentIndex.PORT, void 0)
    ) || null
  )
}
k.uri.utils.getPathEncoded = function () {
  return k.uri.utils.getComponentByIndex_(
    k.uri.utils.ComponentIndex.PATH,
    void 0
  )
}
...
k.uri.utils.getQueryData = function () {
  return k.uri.utils.getComponentByIndex_(
    k.uri.utils.ComponentIndex.QUERY_DATA,
    void 0
  )
}
...
k.uri.utils.haveSameDomain = function (a, b) {
  ...
  return (
    a[k.uri.utils.ComponentIndex.DOMAIN] ==
      b[k.uri.utils.ComponentIndex.DOMAIN] &&
    a[k.uri.utils.ComponentIndex.SCHEME] ==
      b[k.uri.utils.ComponentIndex.SCHEME] &&
...
k.uri.utils.appendKeyValuePairs_ = function (a, b, c) {
  ...
  } else null != b && c.push(a + ("" === b ? "" : "=" + k.string.urlEncode(b)))
}
...
k.uri.utils.findParam_ = function (a, b, c, f) {
  for (var g = c.length; 0 <= (b = a.indexOf(c, b)) && b < f; ) {
    ...
    if (
      ...
      h == k.uri.utils.CharCode_.QUESTION
    )
      if (
        ((h = a.charCodeAt(b + g)),
        !h ||
...
k.uri.utils.hasParam = function (a, b) {
  return (
    0 <= k.uri.utils.findParam_(a, 0, b, a.search(k.uri.utils.hashOrEndRe_))
  )
}
...
k.uri.utils.getParamValues = function (a, b) {
  for (
    ...
    0 <= (g = k.uri.utils.findParam_(a, f, b, c));
...
k.uri.utils.setParamsFromMap = function (a, b) {
  ...
  a[1] = k.uri.utils.appendQueryData_(
    f.join("&"),
    k.uri.utils.buildQueryDataFromMap(b)
  )
  return k.uri.utils.joinQueryData_(a)
}
...
k.Uri = function (a, b) {
  ...
  a instanceof k.Uri
    ...
    : a && (c = k.uri.utils.split(String(a)))
      ...
      : ((this.ignoreCase_ = !!b),
        (this.queryData_ = new k.Uri.QueryData(null, this.ignoreCase_)))
}
...
k.Uri.prototype.toString = function () {
  ...
  b &&
    a.push(
      k.Uri.encodeSpecialChars_(b, k.Uri.reDisallowedInSchemeOrUserInfo_, !0),
      ":"
    )
      ...
      (b = this.getUserInfo()) &&
        a.push(
          k.Uri.encodeSpecialChars_(
            b,
            k.Uri.reDisallowedInSchemeOrUserInfo_,
            !0
          ),
          "@"
        ),
  ...
  if (c) lb(b, a.getPort())
    ...
    if ("/" != f.charAt(0))
      if (this.domain_ && !this.path_) f = "/" + f
        ...
        var g = b.getPath().lastIndexOf("/")
        ;-1 != g && (f = b.getPath().substr(0, g + 1) + f)
      }
...
d.remove = function (a) {
  ...
  return this.keyMap_.containsKey(a)
    ? ((this.encodedQuery_ = null),
      (this.count_ =
        k.asserts.assertNumber(this.count_) - this.keyMap_.get(a).length),
...
var tb = function (a, b, c, f, g, h) {
    ...
    console.log(
      "Making a request to apiary to retrieve licenses for appId: " + b
    )
    rb(
      a,
      r.toString(),
...
var x = { ConstBinaryMessage: function () {} }
...
k.crypt.hexToByteArray = function (a) {
  k.asserts.assert(0 == a.length % 2, "Key string length must be multiple of 2")
...
function yb(a) {
  ...
  if (0 === a) (B = 0 < 1 / a ? 0 : 2147483648), (A = 0)
    ...
    (a /= Math.pow(2, -1074)),
      (B = ((b << 31) | (a / 4294967296)) >>> 0),
      (A = a >>> 0)
  else {
    var c = a,
      f = 0
    if (2 <= c) for (; 2 <= c && 1023 > f; ) f++, (c /= 2)
    else for (; 1 > c && -1022 < f; ) (c *= 2), f--
    a *= Math.pow(2, -f)
...
function Db(a, b) {
  ...
  return 2047 == f
    ...
    : 0 == f
      ? c * Math.pow(2, -1074) * a
      : c * Math.pow(2, f - 1075) * (a + 4503599627370496)
}
function Eb(a, b) {
...
x.utils.hash64ArrayToDecimalStrings = function (a, b) {
  for (var c = Array(a.length), f = 0; f < a.length; f++) c[f] = Hb(a[f], b)
  return c
}
...
x.utils.hexStringToHash64 = function (a) {
  ...
  for (var b = "", c = 0; 8 > c; c++)
    b =
      String.fromCharCode(
        16 * Mb(a.charCodeAt(2 * c + 2)) + Mb(a.charCodeAt(2 * c + 3))
      ) + b
  return b
}
...
d.readSplitVarint64 = function (a) {
  for (var b = 128, c = 0, f = 0, g = 0; 4 > g && 128 <= b; g++)
...
var Qb = function (a) {
  ...
  var c = b[a.cursor_ + 0]
  var f = c & 127
  if (128 > c) return (a.cursor_ += 1), k.asserts.assert(a.cursor_ <= a.end_), f
  c = b[a.cursor_ + 1]
  f |= (c & 127) << 7
  if (128 > c) return (a.cursor_ += 2), k.asserts.assert(a.cursor_ <= a.end_), f
  c = b[a.cursor_ + 2]
  f |= (c & 127) << 14
  if (128 > c) return (a.cursor_ += 3), k.asserts.assert(a.cursor_ <= a.end_), f
  c = b[a.cursor_ + 3]
  f |= (c & 127) << 21
  if (128 > c) return (a.cursor_ += 4), k.asserts.assert(a.cursor_ <= a.end_), f
  c = b[a.cursor_ + 4]
  f |= (c & 15) << 28
  if (128 > c)
...
d.readString = function (a) {
  ...
  for (var f = [], g = ""; c < a; ) {
    ...
    8192 <= f.length &&
      ((g += String.fromCharCode.apply(null, f)), (f.length = 0))
  }
...
d.readBytes = function (a) {
  if (0 > a || this.cursor_ + a > this.bytes_.length)
    return (
      (this.error_ = !0),
      k.asserts.fail("Invalid byte length!"),
      new Uint8Array(0)
    )
    ...
    switch (a.nextWireType_) {
      case z.VARINT:
        if (a.nextWireType_ != z.VARINT)
          ...
          for (a = a.decoder_; a.bytes_[a.cursor_] & 128; ) a.cursor_++
          a.cursor_++
        }
        break
      case z.FIXED64:
      ...
      case z.START_GROUP:
        ...
        do {
          ...
          if (a.nextWireType_ == z.END_GROUP) {
            a.nextField_ != b &&
              (k.asserts.fail("Unmatched end-group tag"), (a.error_ = !0))
            break
          }
          G(a)
        } while (1)
...
x.arith.UInt64.prototype.toString = function () {
  for (var a = "", b = this; 0 != b.lo || 0 != b.hi; ) {
    ...
    for (
      var f = new x.arith.UInt64(10, 0), g = new x.arith.UInt64(1, 0);
      !(f.hi & 2147483648);

    )
      (f = Sb(f)), (g = Sb(g))
    for (; 0 != g.lo || 0 != g.hi; )
      0 >= f.cmp(b) && ((c = c.add(g)), (b = b.sub(f))),
        (f = Rb(f)),
        (g = Rb(g))
    c = [c, b]
    b = c[0]
...
x.arith.UInt64.fromString = function (a) {
  for (
    var b = new x.arith.UInt64(0, 0), c = new x.arith.UInt64(0, 0), f = 0;
    f < a.length;
    f++
  ) {
...
Tb.prototype.writeSplitVarint64 = function (a, b) {
  ...
  for (k.asserts.assert(0 <= b && 4294967296 > b); 0 < b || 127 < a; )
...
k.userAgent.product.isIphoneOrIpod_ = function () {
  return (
    k.labs.userAgent.platform.isIphone() || k.labs.userAgent.platform.isIpod()
  )
}
...
k.userAgent.product.isSafariDesktop_ = function () {
  return (
    k.labs.userAgent.browser.isSafari() && !k.labs.userAgent.platform.isIos()
  )
}
...
k.crypt.base64.ENCODED_VALS_WEBSAFE =
  k.crypt.base64.DEFAULT_ALPHABET_COMMON_ + "-_."
...
k.crypt.base64.ASSUME_NATIVE_SUPPORT_ =
  k.userAgent.GECKO ||
  (k.userAgent.WEBKIT && !k.userAgent.product.SAFARI) ||
  k.userAgent.OPERA
k.crypt.base64.HAS_NATIVE_ENCODE_ =
  k.crypt.base64.ASSUME_NATIVE_SUPPORT_ || "function" == typeof k.global.btoa
k.crypt.base64.HAS_NATIVE_DECODE_ =
  k.crypt.base64.ASSUME_NATIVE_SUPPORT_ ||
  (!k.userAgent.product.SAFARI &&
    !k.userAgent.IE &&
    "function" == typeof k.global.atob)
...
k.crypt.base64.decodeStringInternal_ = function (a, b) {
  ...
  for (var f = 0; ; ) {
    ...
    b((g << 2) | (h >> 4))
    64 != l &&
      (b(((h << 4) & 240) | (l >> 2)), 64 != r && b(((l << 6) & 192) | r))
  }
}
k.crypt.base64.init_ = function () {
  if (!k.crypt.base64.charToByteMap_) {
    ...
    for (
      var a = k.crypt.base64.DEFAULT_ALPHABET_COMMON_.split(""),
        b = ["+/=", "+/", "-_=", "-_.", "-_"],
        c = 0;
      5 > c;
      c++
      ...
      for (var g = 0; g < f.length; g++) {
        ...
        void 0 === l
          ? (k.crypt.base64.charToByteMap_[h] = g)
          : k.asserts.assert(l === g)
      }
    }
  }
}
...
d.writeInt32 = function (a, b) {
  null != b && (ac(a, b, -2147483648 <= b && 2147483648 > b), $b(this, a, b))
}
d.writeInt64 = function (a, b) {
  null != b &&
    (ac(a, b, -9223372036854775808 <= b && 0x7fffffffffffffff > b),
    null != b &&
      (I(this, a, z.VARINT),
      (a = this.encoder_),
      k.asserts.assert(b == Math.floor(b)),
      k.asserts.assert(-9223372036854775808 <= b && 0x7fffffffffffffff > b),
      xb(b),
...
d.writeBool = function (a, b) {
  null != b &&
    (ac(a, b, "boolean" === typeof b || "number" === typeof b),
    I(this, a, z.VARINT),
...
d.writeString = function (a, b) {
  null != b && ((a = Xb(this, a)), this.encoder_.writeString(b), Yb(this, a))
}
...
var bc = function (a, b, c) {
    if (null != c) for (var f = 0; f < c.length; f++) a.writeString(b, c[f])
  },
  K = function (a, b, c, f) {
    if (null != c)
...
gc.prototype.toObject = function (a, b) {
  for (var c = this.toArrayInternal(), f = [], g = 0; g < c.length; g++) {
    ...
    l
      ? (k.asserts.assert(b), f.push([h.key, b(a, l)]))
      : f.push([h.key, h.value])
  }
  return f
}
...
d.set = function (a, b) {
  ...
  var c = new fc(a)
  this.valueCtor
    ? ((c.valueWrapper = b), (c.value = b.toArrayInternal()))
    : (c.value = b)
...
var M = function (a, b, c, f, g) {
  ...
  a: {
    ...
    ;-1 < c
      ? ((a.pivot_ = Math.max(c, L.getFieldNumber(a, b + 1))),
      ...
      (b = f[c]),
        b < a.pivot_
          ? ((b += a.arrayIndexOffset_),
            (a.array[b] = a.array[b] || L.EMPTY_LIST_SENTINEL_))
          : (mc(a),
            (a.extensionObject_[b] =
              a.extensionObject_[b] || L.EMPTY_LIST_SENTINEL_))
  if (g && g.length) for (c = 0; c < g.length; c++) nc(a, g[c])
}
...
var lc = function (a) {
    ...
    for (var h in c)
      if (oc(c, h)) {
        var l = c[h],
          r = f.call(a, l)
        if (null != r) {
          for (var v in l.fieldName) if (l.fieldName.hasOwnProperty(v)) break
          b[v] = l.toObjectFn
            ? l.isRepeated
              ? N(r, l.toObjectFn, g)
              : l.toObjectFn(g, r)
        ...
        if (null != r)
          if (l.ctor)
            if (h.binaryMessageSerializeFn)
              h.binaryWriterFn.call(
                b,
                l.fieldIndex,
                r,
                h.binaryMessageSerializeFn
              )
            else
              throw Error(
  ...
  O = function (a, b) {
    if (b < a.pivot_) {
      b += a.arrayIndexOffset_
      var c = a.array[b]
      return c !== L.EMPTY_LIST_SENTINEL_ || L.isFrozen(a)
        ? c
        : (a.array[b] = [])
    }
    if (a.extensionObject_)
      return (
        ...
        c === L.EMPTY_LIST_SENTINEL_ ? (a.extensionObject_[b] = []) : c
      )
  },
  sc = function (a, b) {
    b = O(a, b)
  ...
  P = function (a, b, c) {
    ...
    L.checkNotFrozen_(a)
    b < a.pivot_
      ? (a.array[b + a.arrayIndexOffset_] = c)
      : (mc(a), (a.extensionObject_[b] = c))
    return a
  },
  zc = function (a, b, c) {
    k.asserts.assertInstanceof(a, L)
  ...
  Q = function (a, b, c) {
    ...
    if (!a.wrappers_[c]) {
      var f = O(a, c)
      f &&
        ((a.wrappers_[c] = new b(f)),
        L.isFrozen(a) && L.internalMarkFrozen(a.wrappers_[c]))
    }
  ...
  V = function (a, b, c) {
    ...
    a.wrappers_ || (a.wrappers_ = {})
    c = c || []
    for (var f = [], g = 0; g < c.length; g++) f[g] = L.toArrayHelper_(c[g], !0)
    a.wrappers_[b] = c
    P(a, b, f)
  },
  W = function (a, b, c, f) {
    ...
    if (Array.isArray(r))
      (r = Dc(
        ...
        Array.isArray(b)
          ? b[l]
          : b && b.wrappers_
            ? b.wrappers_[L.getFieldNumber(b, l)]
            : void 0
      )),
        !r.length &&
          b &&
  ...
  return a.isRepeated
    ? a.ctor
      ? (this.wrappers_[c] ||
        ...
        this.wrappers_[c])
      : b
        ? ((c = this.extensionObject_[c]),
          c || ((c = []), L.internalMarkFrozen(c)),
          c)
...
L.prototype.setExtension = function (a, b) {
  ...
  a.isRepeated
    ...
    : a.ctor
      ? ((this.wrappers_[c] = b),
        (this.extensionObject_[c] = b ? L.toArrayHelper_(b, !0) : b))
      : (this.extensionObject_[c] = b)
  return this
}
...
var Fc = function (a, b) {
    ...
    for (f in c) if (oc(c, f) && !Ec(a[f], b[f])) return !1
    return !0
  },
  Ec = function (a, b) {
    if (a == b) return !0
...
L.GENERATE_TO_OBJECT &&
  ...
  (Y.google.type.LatLng.toObject = function (a, b) {
    var c = { latitude: yc(b, 1), longitude: yc(b, 2) }
...
Y.google.type.LatLng.deserializeBinary = function (a) {
  return Y.google.type.LatLng.deserializeBinaryFromReader(
    new Y.google.type.LatLng(),
    new C(a)
  )
}
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.postaladdress.PostalAddress.fromObject = function (a) {
    ...
    null != a.administrativeAreaName && P(b, 3, a.administrativeAreaName)
    null != a.subAdministrativeAreaName && P(b, 4, a.subAdministrativeAreaName)
    null != a.localityName && P(b, 5, a.localityName)
    null != a.dependentLocalityName && P(b, 17, a.dependentLocalityName)
    null != a.thoroughfareName && P(b, 6, a.thoroughfareName)
    null != a.thoroughfareNumber && P(b, 11, a.thoroughfareNumber)
    null != a.dependentThoroughfareName && P(b, 21, a.dependentThoroughfareName)
    null != a.postalCodeNumber && P(b, 12, a.postalCodeNumber)
    null != a.postalCodeNumberExtension && P(b, 13, a.postalCodeNumberExtension)
    null != a.sortingCode && P(b, 29, a.sortingCode)
    null != a.postBoxNumber && P(b, 30, a.postBoxNumber)
    null != a.premiseName && P(b, 15, a.premiseName)
...
L.messageSetExtensions[3514611] =
  Y.postaladdress.PostalAddress.messageSetExtension
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.FundsGuaranteeId.prototype.toObject = function (
    a
  ) {
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.moneta.integrator.common.FundsGuaranteeId.fromObject = function (a) {
    ...
    null != a.fundsGuaranteeRequestId && P(b, 2, a.fundsGuaranteeRequestId)
    return b
  }))
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.ProductCorrelationId.prototype.toObject =
    function (a) {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.ProductCorrelationId.ObjectFormat =
    function () {}),
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.SubscriptionId.prototype.toObject = function (
    a
  ) {
...
Y.moneta.integrator.common.SubscriptionId.serializeBinaryToWriter = function (
  a,
  b
) {
  var c = O(a, 1)
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.callbacks.common.CallbackRequestHeader.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.callbacks.common.CallbackRequestHeader.toObject(
        a,
        this
      )
    }),
    ...
    function (a, b) {
      var c,
        f = {
          ...
          subscriptionId:
            (c = b.getSubscriptionId()) &&
            Y.moneta.integrator.common.SubscriptionId.toObject(a, c),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.callbacks.common.CallbackRequestHeader.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.callbacks.common.CallbackRequestHeader.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.callbacks.common.CallbackRequestHeader()
      a.productCorrelationId &&
        S(
          b,
          1,
          Y.moneta.integrator.common.ProductCorrelationId.fromObject(
            a.productCorrelationId
          )
        )
      a.fundsGuaranteeId &&
        S(
          b,
          3,
          Y.moneta.integrator.common.FundsGuaranteeId.fromObject(
            a.fundsGuaranteeId
          )
        )
      a.subscriptionId &&
        S(
          b,
          7,
          Y.moneta.integrator.common.SubscriptionId.fromObject(a.subscriptionId)
        )
      ...
      null != a.resourceForPermissionCheck &&
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        case 1:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.ProductCorrelationId
        ...
        case 3:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.FundsGuaranteeId
              .deserializeBinaryFromReader
          )
        ...
        case 7:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.SubscriptionId
              .deserializeBinaryFromReader
          )
  ...
  function (a, b) {
    ...
    null != c &&
      J(
        ...
        3,
        c,
        Y.moneta.integrator.common.FundsGuaranteeId.serializeBinaryToWriter
      )
    ...
    null != c &&
      J(
        ...
        7,
        c,
        Y.moneta.integrator.common.SubscriptionId.serializeBinaryToWriter
      )
    c = O(a, 6)
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.CustomFieldValue.prototype.toObject =
    function (a) {
  ...
  (Y.moneta.integrator.common.buyflow.CustomFieldValue.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.CustomFieldValue.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.buyflow.CustomFieldValue.fromObject = function (
    a
  ) {
      ...
      switch (b.getFieldNumber()) {
        ...
        case 2:
          ...
          Bc(
            a,
            2,
            Y.moneta.integrator.common.buyflow.CustomFieldValue.oneofGroups_[0],
            c
          )
          break
        case 3:
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.CustomSectionDetailsValue.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.buyflow.CustomSectionDetailsValue.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.CustomSectionDetailsValue.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.buyflow.CustomSectionDetailsValue.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.buyflow.CustomSectionDetailsValue()
      a.fieldValueList &&
        V(
          b,
          1,
          a.fieldValueList.map(
            Y.moneta.integrator.common.buyflow.CustomFieldValue.fromObject
          )
        )
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.html.SafeHtmlProto.fromObject = function (a) {
    ...
    null != a.privateDoNotAccessOrElseSafeHtmlWrappedValue &&
      P(b, 2, a.privateDoNotAccessOrElseSafeHtmlWrappedValue)
    return b
  }))
Y.html.SafeHtmlProto.deserializeBinary = function (a) {
  return Y.html.SafeHtmlProto.deserializeBinaryFromReader(
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.FinancingParameters.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.buyflow.FinancingParameters.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.buyflow.FinancingParameters.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.FinancingParameters.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.buyflow.FinancingParameters.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.buyflow.FinancingParameters()
      null != a.userFacingTransactionId && P(b, 6, a.userFacingTransactionId)
      null != a.financingProvider && P(b, 9, a.financingProvider)
      null != a.financingType && P(b, 1, a.financingType)
      null != a.financingTypeDurationMonths &&
        P(b, 4, a.financingTypeDurationMonths)
      null != a.annualPercentageRate && P(b, 8, a.annualPercentageRate)
      a.offerDescriptionHtml &&
        S(b, 2, Y.html.SafeHtmlProto.fromObject(a.offerDescriptionHtml))
...
Y.moneta.integrator.common.Amount.deserializeBinaryFromReader = function (
  a,
  b
) {
  for (; F(b) && !D(b); )
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.cart.TaxDetails.prototype.toObject = function (
    a
  ) {
  ...
  (Y.moneta.integrator.common.cart.TaxDetails.toObject = function (a, b) {
    var c,
      f = {
        pretaxAmount:
          (c = Hc(b)) && Y.moneta.integrator.common.Amount.toObject(a, c),
        taxAmount:
          (c = Ic(b)) && Y.moneta.integrator.common.Amount.toObject(a, c),
        totalAmount:
          (c = Jc(b)) && Y.moneta.integrator.common.Amount.toObject(a, c),
      }
    a && (f.$jspbMessageInstance = b)
    return f
  }))
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.moneta.integrator.common.cart.TaxDetails.fromObject = function (a) {
    ...
    a.pretaxAmount &&
      S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.pretaxAmount))
    a.taxAmount &&
      S(b, 2, Y.moneta.integrator.common.Amount.fromObject(a.taxAmount))
    a.totalAmount &&
      S(b, 3, Y.moneta.integrator.common.Amount.fromObject(a.totalAmount))
    return b
  }))
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        case 1:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.Amount.deserializeBinaryFromReader
          )
          a.setPretaxAmount(c)
          break
        case 2:
...
Y.moneta.integrator.common.cart.TaxDetails.serializeBinaryToWriter = function (
  ...
  var c = Hc(a)
  null != c &&
    J(b, 1, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
  c = Ic(a)
  null != c &&
    J(b, 2, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
  c = Jc(a)
  null != c &&
    J(b, 3, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
}
var Hc = function (a) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.toObject(
        a,
        this
      )
    }),
    ...
    function (a, b) {
      var c,
        f = {
          ...
          taxDetails:
            (c = b.getTaxDetails()) &&
            Y.moneta.integrator.common.cart.TaxDetails.toObject(a, c),
        }
      a && (f.$jspbMessageInstance = b)
      return f
    }))
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.cart.LineItemDetailComputedInfo()
      null != a.lineItemDetailIndex && P(b, 1, a.lineItemDetailIndex)
      a.taxDetails &&
        S(
          b,
          2,
          Y.moneta.integrator.common.cart.TaxDetails.fromObject(a.taxDetails)
        )
      return b
    }))
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        ...
        case 2:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.cart.TaxDetails
              .deserializeBinaryFromReader
          )
          a.setTaxDetails(c)
          break
...
Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 1)
    null != c && b.writeInt32(1, c)
    c = a.getTaxDetails()
    null != c &&
      J(
        ...
        2,
        c,
        Y.moneta.integrator.common.cart.TaxDetails.serializeBinaryToWriter
      )
  }
Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.prototype.getTaxDetails =
  function () {
    return Q(this, Y.moneta.integrator.common.cart.TaxDetails, 2)
  }
Y.moneta.integrator.common.cart.LineItemDetailComputedInfo.prototype.setTaxDetails =
  function (a) {
    S(this, 2, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.cart.PriceDetails.prototype.toObject = function (
    a
  ) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.tax.TaxDisplay.prototype.toObject = function (
    a
  ) {
...
Y.moneta.integrator.common.tax.TaxDisplay.serializeBinaryToWriter = function (
  a,
  b
) {
  var c = O(a, 1)
...
Y.moneta.integrator.common.tax.TaxDisplayDetails = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.tax.TaxDisplayDetails.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.tax.TaxDisplayDetails.prototype.toObject =
    function (a) {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.tax.TaxDisplayDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.tax.TaxDisplayDetails.fromObject = function (a) {
    ...
    a.taxDisplayList &&
      V(
        b,
        1,
        a.taxDisplayList.map(
          Y.moneta.integrator.common.tax.TaxDisplay.fromObject
        )
      )
    return b
  }))
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        case 1:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.tax.TaxDisplay
              .deserializeBinaryFromReader
          )
  ...
  function (a, b) {
    ...
    0 < a.length &&
      K(
        ...
        1,
        a,
        Y.moneta.integrator.common.tax.TaxDisplay.serializeBinaryToWriter
      )
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.address.AddressDeliveryInstruction.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.address.AddressDeliveryInstruction.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.address.AddressDeliveryInstruction.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.address.AddressDeliveryInstruction.fromObject =
    function (a) {
      ...
      null != a.addressDeliveryInstructionValue &&
        P(b, 2, a.addressDeliveryInstructionValue)
      return b
    }))
Y.moneta.integrator.common.address.AddressDeliveryInstruction.deserializeBinary =
  function (a) {
...
Y.moneta.integrator.common.address.AddressDeliveryInstruction.AddressDeliveryInstructionType =
  { UNKNOWN: 0, GATE_CODE: 1, EXTRA_INSTRUCTIONS: 2 }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.address.AddressGeocodingInfo.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.address.AddressGeocodingInfo.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.address.AddressGeocodingInfo.toObject = function (
    a,
    b
  ) {
    var c,
      f = {
        latLng:
          (c = Q(b, Y.google.type.LatLng, 1)) &&
          Y.google.type.LatLng.toObject(a, c),
      }
    a && (f.$jspbMessageInstance = b)
    return f
  }))
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.address.AddressGeocodingInfo.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.address.AddressGeocodingInfo.fromObject =
    function (a) {
...
Y.moneta.integrator.common.address.AddressGeocodingInfo.serializeBinaryToWriter =
  function (a, b) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.address.AddressLabel.prototype.toObject =
    function (a) {
  ...
  (Y.moneta.integrator.common.address.AddressLabel.toObject = function (a, b) {
    ...
    c = void 0 === c ? !1 : c
    var h = wc(b, 3)
    f = { labelType: f, customLabel: g, universalAccess: null == h ? c : h }
    a && (f.$jspbMessageInstance = b)
    return f
  }))
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.address.AddressLabel.ObjectFormat =
    function () {}),
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.address.Address.prototype.toObject = function (
    a
  ) {
  ...
  (Y.moneta.integrator.common.address.Address.toObject = function (a, b) {
    var c,
      f = {
        ...
        address:
          (c = b.getAddress()) && Y.postaladdress.PostalAddress.toObject(a, c),
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.moneta.integrator.common.address.Address.fromObject = function (a) {
    ...
    null != a.addressNormalizationType && P(b, 7, a.addressNormalizationType)
    null != a.normalizationResultType && P(b, 9, a.normalizationResultType)
    ...
    a.addressLabelList &&
      V(
        b,
        6,
        a.addressLabelList.map(
          Y.moneta.integrator.common.address.AddressLabel.fromObject
        )
      )
    return b
  }))
      ...
      switch (b.getFieldNumber()) {
        case 1:
          ...
          Bc(
            a,
            1,
            Y.moneta.integrator.common.address.Address.oneofGroups_[0],
            c
          )
          break
        case 8:
        ...
        case 6:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.address.AddressLabel
              .deserializeBinaryFromReader
          )
...
Y.moneta.integrator.common.address.Address.serializeBinaryToWriter = function (
  ...
  c = a.getAddress()
  null != c && J(b, 2, c, Y.postaladdress.PostalAddress.serializeBinaryToWriter)
  c = O(a, 7)
...
Y.moneta.integrator.common.tax.Tax.deserializeBinaryFromReader = function (
  a,
  b
) {
  for (; F(b) && !D(b); )
...
Y.moneta.integrator.common.tax.TaxDetails = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.tax.TaxDetails.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.tax.TaxDetails.prototype.toObject = function (
    a
  ) {
  ...
  (Y.moneta.integrator.common.tax.TaxDetails.fromObject = function (a) {
    ...
    a.assesseeAddress &&
      S(
        b,
        1,
        Y.moneta.integrator.common.address.Address.fromObject(a.assesseeAddress)
      )
    a.taxList &&
      V(b, 2, a.taxList.map(Y.moneta.integrator.common.tax.Tax.fromObject))
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        case 1:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.address.Address
              .deserializeBinaryFromReader
          )
          S(a, 1, c)
          break
...
Y.moneta.integrator.common.tax.TaxDetails.serializeBinaryToWriter = function (
  a,
  b
) {
  ...
  0 < c.length &&
    K(b, 2, c, Y.moneta.integrator.common.tax.Tax.serializeBinaryToWriter)
  c = O(a, 3)
...
Y.moneta.integrator.common.cart.LineItemComputedInfo = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.cart.LineItemComputedInfo.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.cart.LineItemComputedInfo.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.cart.LineItemComputedInfo.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.cart.LineItemComputedInfo.toObject = function (
    a,
    b
  ) {
    var c,
      f = {
        ...
        totalTaxDetails:
          (c = b.getTotalTaxDetails()) &&
          Y.moneta.integrator.common.cart.TaxDetails.toObject(a, c),
        priceDetails:
          (c = b.getPriceDetails()) &&
          Y.moneta.integrator.common.cart.PriceDetails.toObject(a, c),
        taxDetails:
          (c = b.getTaxDetails()) &&
          Y.moneta.integrator.common.tax.TaxDetails.toObject(a, c),
        taxDisplayDetails:
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.cart.LineItemComputedInfo.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.cart.LineItemComputedInfo.fromObject = function (
    a
  ) {
    ...
    a.totalTaxDetails &&
      S(
        b,
        3,
        Y.moneta.integrator.common.cart.TaxDetails.fromObject(a.totalTaxDetails)
      )
    a.priceDetails &&
      S(
        b,
        4,
        Y.moneta.integrator.common.cart.PriceDetails.fromObject(a.priceDetails)
      )
    a.taxDetails &&
      S(
        b,
        5,
        Y.moneta.integrator.common.tax.TaxDetails.fromObject(a.taxDetails)
      )
    a.taxDisplayDetails &&
      S(
        b,
        6,
        Y.moneta.integrator.common.tax.TaxDisplayDetails.fromObject(
          a.taxDisplayDetails
        )
      )
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        ...
        case 5:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.tax.TaxDetails
              .deserializeBinaryFromReader
          )
          a.setTaxDetails(c)
          break
        case 6:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.tax.TaxDisplayDetails
              .deserializeBinaryFromReader
          )
          S(a, 6, c)
          break
  ...
  function (a, b) {
    ...
    null != c &&
      J(
        ...
        5,
        c,
        Y.moneta.integrator.common.tax.TaxDetails.serializeBinaryToWriter
      )
...
Y.moneta.integrator.common.cart.CartComputedInfo = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.cart.CartComputedInfo.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.cart.CartComputedInfo.prototype.toObject =
    function (a) {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.cart.CartComputedInfo.ObjectFormat =
    function () {}),
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.ApprovalDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.ApprovalDetails.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.ApprovalDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.ApprovalDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.ApprovalDetails()
      a.approvedAmount &&
        S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.approvedAmount))
      null != a.cancelAvailabilityMillis && P(b, 3, a.cancelAvailabilityMillis)
      null != a.delayedChargingApproved && P(b, 4, a.delayedChargingApproved)
      return b
    }))
...
Y.moneta.integrator.common.fundsguarantee.ApprovalDetails.serializeBinaryToWriter =
  function (a, b) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.toObject =
    function (a, b) {
      var c,
        f = {
          chargebackAmount:
            (c = b.getChargebackAmount()) &&
            Y.moneta.integrator.common.Amount.toObject(a, c),
          ...
          reverseDetails:
            ...
            Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.ReverseDetails.toObject(
              a,
              c
            ),
        }
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.ChargebackDetails()
      a.chargebackAmount &&
        S(
          b,
          1,
          Y.moneta.integrator.common.Amount.fromObject(a.chargebackAmount)
        )
      a.positiveChargebackAmount &&
        S(
          b,
          2,
          Y.moneta.integrator.common.Amount.fromObject(
            a.positiveChargebackAmount
          )
        )
      ...
      switch (b.getFieldNumber()) {
        ...
        case 4:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.fundsguarantee.ChargebackDetails
              .ReverseDetails.deserializeBinaryFromReader
          )
          S(a, 4, c)
          break
        default:
  ...
  function (a, b) {
    ...
    null != c &&
      J(
        ...
        c,
        Y.moneta.integrator.common.fundsguarantee.ChargebackDetails
          .ReverseDetails.serializeBinaryToWriter
      )
  }
L.GENERATE_TO_OBJECT &&
...
Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.ReverseDetails.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.fundsguarantee.ChargebackDetails
        .ReverseDetails,
...
Y.moneta.integrator.common.fundsguarantee.ChargebackDetails.prototype.setFraudCategory =
  function (a) {
    P(this, 3, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.ChargeDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.ChargeDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.ChargeDetails.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.ChargeDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.ChargeDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.ChargeDetails()
      a.chargedAmount &&
        S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.chargedAmount))
      a.chargeFailedAmount &&
        S(
          b,
          2,
          Y.moneta.integrator.common.Amount.fromObject(a.chargeFailedAmount)
        )
      null != a.refundAvailabilityMillis && P(b, 3, a.refundAvailabilityMillis)
      return b
    }))
...
Y.moneta.integrator.common.fundsguarantee.ChargeDetails.serializeBinaryToWriter =
  function (a, b) {
...
Y.moneta.integrator.common.fundsguarantee.ChargeDetails.prototype.getChargedAmount =
  function () {
    return Q(this, Y.moneta.integrator.common.Amount, 1)
  }
Y.moneta.integrator.common.fundsguarantee.ChargeDetails.prototype.setChargedAmount =
  function (a) {
    S(this, 1, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.DeclineDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.DeclineDetails.toObject(
        a,
        this
      )
    }),
      ...
      var c,
        f = {
          ...
          primaryAction:
            ...
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ErrorAction.toObject(
              a,
              c
            ),
          couponCodeAbuse:
            ...
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails.CouponCodeAbuse.toObject(
              a,
              c
            ),
          ...
          dasherPolicy:
            ...
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DasherPolicy.toObject(
              a,
              c
            ),
          issuerDeclined:
            ...
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails.IssuerDeclined.toObject(
              a,
              c
            ),
        }
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.DeclineDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.DeclineDetails()
      null != a.declineReason && P(b, 2, a.declineReason)
      null != a.declineReasonUserMessage && P(b, 1, a.declineReasonUserMessage)
      a.primaryAction &&
        S(
          b,
          4,
      ...
      switch (b.getFieldNumber()) {
        ...
        case 5:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails
              .CouponCodeAbuse.deserializeBinaryFromReader
          )
          U(
            a,
            5,
        ...
        case 6:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails
              .DisallowedInstrument.deserializeBinaryFromReader
          )
          U(
            a,
            6,
        ...
        case 7:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails
              .SpendingLimitExceeded.deserializeBinaryFromReader
          )
          U(
            a,
            7,
        ...
        case 9:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.fundsguarantee.DeclineDetails
              .IssuerDeclined.deserializeBinaryFromReader
          )
          S(a, 9, c)
          break
        default:
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 2)
    null != c && b.writeEnum(2, c)
    c = O(a, 1)
    ...
    null != c &&
      J(
        ...
        c,
        Y.moneta.integrator.common.fundsguarantee.DeclineDetails
          .DisallowedInstrument.serializeBinaryToWriter
      )
    c = Q(
      a,
      Y.moneta.integrator.common.fundsguarantee.DeclineDetails
    ...
    null != c &&
      J(
        ...
        c,
        Y.moneta.integrator.common.fundsguarantee.DeclineDetails
          .SpendingLimitExceeded.serializeBinaryToWriter
      )
    c = Q(
      a,
      Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DasherPolicy,
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ErrorAction.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ErrorAction.toObject(
        a,
        this
      )
    }),
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ErrorAction.deserializeBinary =
  function (a) {
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ErrorAction.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.fundsguarantee.DeclineDetails.ErrorAction,
      a
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.CouponCodeAbuse.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.fundsguarantee.DeclineDetails.CouponCodeAbuse,
      a
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DisallowedInstrument.fromObject =
    function (a) {
      var b =
        new Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DisallowedInstrument()
      null != a.disallowedInstrumentType && P(b, 1, a.disallowedInstrumentType)
      return b
    }))
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DasherPolicy.deserializeBinary =
  function (a) {
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DasherPolicy.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.fundsguarantee.DeclineDetails.DasherPolicy,
      a
...
Y.moneta.integrator.common.fundsguarantee.DeclineDetails.IssuerDeclined.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.fundsguarantee.DeclineDetails.IssuerDeclined,
      a
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.FundsAvailability.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.FundsAvailability.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.FundsAvailability.toObject =
    function (a, b) {
      var c,
        f = {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.FundsAvailability.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.FundsAvailability.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.FundsAvailability()
      null != a.fundsAvailabilityMillis && P(b, 1, a.fundsAvailabilityMillis)
      null != a.fundsAvailabilityMessage && P(b, 3, a.fundsAvailabilityMessage)
      return b
    }))
...
Y.moneta.integrator.common.fundsguarantee.FundsAvailability.FundsAvailabilityMessage =
  { UNKNOWN: 0, DEFAULT: 1, WARN_FOR_POTENTIAL_FRAUD: 2 }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.DisburseDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.DisburseDetails.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.DisburseDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.DisburseDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.DisburseDetails()
      a.disbursedAmount &&
        S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.disbursedAmount))
      a.disbursePendingAmount &&
        S(
          b,
          2,
          Y.moneta.integrator.common.Amount.fromObject(a.disbursePendingAmount)
        )
      a.disburseFailedAmount &&
        S(
          b,
          3,
          Y.moneta.integrator.common.Amount.fromObject(a.disburseFailedAmount)
        )
      a.fundsAvailability &&
        S(
          b,
...
Y.moneta.integrator.common.fundsguarantee.DisburseDetails.serializeBinaryToWriter =
  function (a, b) {
...
Y.moneta.integrator.common.fundsguarantee.DisburseDetails.prototype.setDisbursedAmount =
  function (a) {
    S(this, 1, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.SystemRetryDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.SystemRetryDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.SystemRetryDetails.toObject =
    function (a, b) {
      var c,
        f = {
          declineDetails:
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.SystemRetryDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.SystemRetryDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.SystemRetryDetails()
      a.declineDetails &&
        S(
          b,
          1,
      ...
      null != a.paymentRetryAttemptCount && P(b, 2, a.paymentRetryAttemptCount)
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.UserActionDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.UserActionDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.UserActionDetails.toObject =
    function (a, b) {
      var c,
        f = {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.UserActionDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.UserActionDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.UserActionDetails()
      null != a.userActionType && P(b, 1, a.userActionType)
      null != a.instructionExpirationTimeMillis &&
        P(b, 2, a.instructionExpirationTimeMillis)
      return b
    }))
...
Y.moneta.integrator.common.fundsguarantee.UserActionDetails.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 1)
    null != c && b.writeEnum(1, c)
    c = O(a, 2)
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.PendingDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.PendingDetails.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.PendingDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.PendingDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.PendingDetails()
...
Y.moneta.integrator.common.fundsguarantee.PendingDetails.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 1)
    null != c && b.writeEnum(1, c)
...
Y.moneta.integrator.common.fundsguarantee.PendingDetails.prototype.setFundsAvailability =
  function (a) {
    S(this, 17, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.RefundDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.RefundDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.RefundDetails.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.RefundDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.RefundDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.RefundDetails()
      a.refundedAmount &&
        S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.refundedAmount))
      a.refundFailedAmount &&
        S(
          b,
          2,
          Y.moneta.integrator.common.Amount.fromObject(a.refundFailedAmount)
        )
      return b
    }))
...
Y.moneta.integrator.common.fundsguarantee.RefundDetails.serializeBinaryToWriter =
  function (a, b) {
...
Y.moneta.integrator.common.fundsguarantee.RefundDetails.prototype.getRefundedAmount =
  function () {
    return Q(this, Y.moneta.integrator.common.Amount, 1)
  }
Y.moneta.integrator.common.fundsguarantee.RefundDetails.prototype.setRefundedAmount =
  function (a) {
    S(this, 1, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.SystemBlockedDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.SystemBlockedDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.SystemBlockedDetails.toObject =
    function (a, b) {
      var c,
        f = {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.SystemBlockedDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.SystemBlockedDetails.fromObject =
    function (a) {
      ...
      a.blockedAmount &&
        S(b, 2, Y.moneta.integrator.common.Amount.fromObject(a.blockedAmount))
      null != a.blockedReason && P(b, 3, a.blockedReason)
      return b
    }))
Y.moneta.integrator.common.fundsguarantee.SystemBlockedDetails.deserializeBinary =
  function (a) {
...
Y.moneta.integrator.common.TillId.deserializeBinaryFromReader = function (
  a,
  b
) {
  for (; F(b) && !D(b); )
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.toObject =
    function (a, b) {
      var c,
        f = {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.fromObject =
    function (a) {
      ...
      a.tillId &&
        S(b, 2, Y.moneta.integrator.common.TillId.fromObject(a.tillId))
      null != a.externalTransactionId && P(b, 3, a.externalTransactionId)
      return b
    }))
Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.deserializeBinary =
  function (a) {
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        ...
        case 2:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.TillId.deserializeBinaryFromReader
          )
          S(a, 2, c)
          break
        case 3:
...
Y.moneta.integrator.common.fundsguarantee.CashPurchaseDetails.serializeBinaryToWriter =
  function (a, b) {
    ...
    null != c &&
      J(b, 2, c, Y.moneta.integrator.common.TillId.serializeBinaryToWriter)
    c = O(a, 3)
    null != c && b.writeString(3, c)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.instrument.InstrumentDescription.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.instrument.InstrumentDescription.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.instrument.InstrumentDescription.toObject =
    function (a, b) {
      var c,
        f = {
          ...
          instrumentLegalDisclaimerList: N(
            ...
            Y.moneta.integrator.common.instrument.InstrumentDescription
              .InstrumentLegalDisclaimer.toObject,
            a
          ),
          ...
          balanceInfo:
            ...
            Y.moneta.integrator.common.instrument.InstrumentDescription.BalanceInfo.toObject(
              a,
              c
            ),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.instrument.InstrumentDescription.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.instrument.InstrumentDescription.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.instrument.InstrumentDescription()
      ...
      null != a.instrumentSubDescription && P(b, 7, a.instrumentSubDescription)
      ...
      switch (b.getFieldNumber()) {
        ...
        case 8:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.instrument.InstrumentDescription
              .InstrumentLegalDisclaimer.deserializeBinaryFromReader
          )
          W(
            a,
            8,
        ...
        case 5:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.instrument.InstrumentDescription
              .BalanceInfo.deserializeBinaryFromReader
          )
          S(a, 5, c)
          break
        case 9:
  ...
  function (a, b) {
    ...
    0 < c.length &&
      K(
        ...
        c,
        Y.moneta.integrator.common.instrument.InstrumentDescription
          .InstrumentLegalDisclaimer.serializeBinaryToWriter
      )
    c = O(a, 3)
    null != c && b.writeString(3, c)
    c = O(a, 4)
  ...
  (Y.moneta.integrator.common.instrument.InstrumentDescription.BalanceInfo.toObject =
    function (a, b) {
      var c,
        f = {
          availableAmount:
            (c = Kc(b)) && Y.moneta.integrator.common.Amount.toObject(a, c),
          promotionalAmount:
            (c = Q(b, Y.moneta.integrator.common.Amount, 2)) &&
            Y.moneta.integrator.common.Amount.toObject(a, c),
  ...
  (Y.moneta.integrator.common.instrument.InstrumentDescription.BalanceInfo.fromObject =
    function (a) {
      var b =
        new Y.moneta.integrator.common.instrument.InstrumentDescription.BalanceInfo()
      a.availableAmount &&
        S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.availableAmount))
      a.promotionalAmount &&
        S(
          b,
          2,
          Y.moneta.integrator.common.Amount.fromObject(a.promotionalAmount)
        )
      ...
      switch (b.getFieldNumber()) {
        ...
        case 4:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.instrument.InstrumentDescription
              .PromotionalBalance.deserializeBinaryFromReader
          )
          W(
            a,
            4,
  ...
  function (a, b) {
    ...
    0 < c.length &&
      K(
        ...
        c,
        Y.moneta.integrator.common.instrument.InstrumentDescription
          .PromotionalBalance.serializeBinaryToWriter
      )
  }
var Kc = function (a) {
  return Q(a, Y.moneta.integrator.common.Amount, 1)
...
Y.moneta.integrator.common.instrument.InstrumentDescription.BalanceInfo.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.instrument.InstrumentDescription.BalanceInfo,
      a
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.InstallmentDetailsPb.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.InstallmentDetailsPb.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.fundsguarantee.InstallmentDetailsPb.toObject =
    function (a, b) {
      var c,
        f = {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.InstallmentDetailsPb.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.InstallmentDetailsPb.fromObject =
    function (a) {
      ...
      null != a.initialBackingInstrumentId &&
        P(b, 1, a.initialBackingInstrumentId)
...
Y.moneta.integrator.common.fundsguarantee.InstallmentDetailsPb.deserializeBinary =
  function (a) {
...
L.GENERATE_FROM_OBJECT &&
  ...
  (Y.moneta.integrator.common.fundsguarantee.FundsGuaranteePaymentDetails.fromObject =
    function (a) {
      ...
      a.amount &&
        S(b, 1, Y.moneta.integrator.common.Amount.fromObject(a.amount))
      a.refundedAmount &&
        S(b, 5, Y.moneta.integrator.common.Amount.fromObject(a.refundedAmount))
      a.chargedAmount &&
        S(b, 6, Y.moneta.integrator.common.Amount.fromObject(a.chargedAmount))
      ...
      switch (b.getFieldNumber()) {
        ...
        case 9:
          ...
          U(
            ...
            9,
            Y.moneta.integrator.common.fundsguarantee
              .FundsGuaranteePaymentDetails.oneofGroups_[0],
            c
          )
          break
        case 10:
...
Y.moneta.integrator.common.fundsguarantee.FundsGuaranteePaymentDetails.serializeBinaryToWriter =
  function (a, b) {
    ...
    null != c &&
      J(b, 5, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
    c = a.getChargedAmount()
    null != c &&
      J(b, 6, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
...
Y.moneta.integrator.common.fundsguarantee.FundsGuaranteePaymentDetails.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.fundsguarantee.FundsGuaranteePaymentDetails,
      a
...
Y.moneta.integrator.common.fundsguarantee.FundsGuarantee = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.fundsguarantee.FundsGuarantee.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.FundsGuarantee.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.fundsguarantee.FundsGuarantee.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.fundsguarantee.FundsGuarantee.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.fundsguarantee.FundsGuarantee.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.fundsguarantee.FundsGuarantee()
      a.fundsGuaranteeId &&
        S(
          b,
          1,
      ...
      a.amount &&
        S(b, 3, Y.moneta.integrator.common.Amount.fromObject(a.amount))
      a.chargedAmount &&
        S(b, 8, Y.moneta.integrator.common.Amount.fromObject(a.chargedAmount))
      a.refundedAmount &&
        S(b, 9, Y.moneta.integrator.common.Amount.fromObject(a.refundedAmount))
      a.chargebackAmount &&
        S(
          b,
          10,
      ...
      a.disbursedAmount &&
        S(
          b,
          11,
          Y.moneta.integrator.common.Amount.fromObject(a.disbursedAmount)
        )
      ...
      null != a.expirationTimeMillis && P(b, 4, a.expirationTimeMillis)
      ...
      switch (b.getFieldNumber()) {
        ...
        case 7:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.fundsguarantee
              .FundsGuaranteePaymentDetails.deserializeBinaryFromReader
          )
          W(
            a,
            7,
...
Y.moneta.integrator.common.fundsguarantee.FundsGuarantee.serializeBinaryToWriter =
  function (a, b) {
    ...
    c = a.getChargedAmount()
    null != c &&
      J(b, 8, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
    c = a.getRefundedAmount()
    null != c &&
      J(b, 9, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
    c = a.getChargebackAmount()
    null != c &&
      J(b, 10, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
    c = a.getDisbursedAmount()
    null != c &&
      J(b, 11, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
    c = R(
      a,
      Y.moneta.integrator.common.fundsguarantee.FundsGuaranteePaymentDetails,
      7
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.IntegratorPurchaseOrderResponse.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.buyflow.IntegratorPurchaseOrderResponse.toObject(
        a,
        this
      )
    }),
    ...
    function (a) {
      ...
      a.cartComputedInfo &&
        S(
          b,
          2,
          Y.moneta.integrator.common.cart.CartComputedInfo.fromObject(
            a.cartComputedInfo
          )
        )
      a.fundsGuarantee &&
...
Y.moneta.integrator.common.buyflow.IntegratorPurchaseOrderResponse.deserializeBinary =
  function (a) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.customer.Contact.prototype.toObject = function (
    a
  ) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.SelectedPickUpDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.buyflow.SelectedPickUpDetails.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.SelectedPickUpDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.buyflow.SelectedPickUpDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.buyflow.SelectedPickUpDetails()
      null != a.storeId && P(b, 1, a.storeId)
      a.contact &&
        S(
          b,
          2,
          Y.moneta.integrator.common.customer.Contact.fromObject(a.contact)
        )
      return b
    }))
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        ...
        case 2:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.customer.Contact
              .deserializeBinaryFromReader
          )
          S(a, 2, c)
          break
...
Y.moneta.integrator.common.buyflow.SelectedPickUpDetails.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 1)
    null != c && b.writeString(1, c)
    ...
    null != c &&
      J(
        ...
        2,
        c,
        Y.moneta.integrator.common.customer.Contact.serializeBinaryToWriter
      )
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.SelectedShippingDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.buyflow.SelectedShippingDetails.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.buyflow.SelectedShippingDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.buyflow.SelectedShippingDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.buyflow.SelectedShippingDetails()
      null != a.shippingOptionName && P(b, 3, a.shippingOptionName)
      a.address &&
        S(
          b,
          4,
          Y.moneta.integrator.common.address.Address.fromObject(a.address)
        )
      null != a.integratorShippingOptionDataToken &&
        P(b, 5, a.integratorShippingOptionDataToken)
      return b
    }))
...
Y.moneta.integrator.common.buyflow.SelectedShippingDetails.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 3)
    null != c && b.writeString(3, c)
    c = a.getAddress()
...
Y.moneta.integrator.common.buyflow.SelectedShippingDetails.prototype.getAddress =
  function () {
    return Q(this, Y.moneta.integrator.common.address.Address, 4)
  }
Y.moneta.integrator.common.buyflow.SelectedShippingDetails.prototype.setAddress =
  function (a) {
    S(this, 4, a)
  }
...
Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData = function (a) {
  M(
    ...
    a,
    15,
    Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.toObject =
    function (a, b) {
      ...
      pc(
        ...
        f,
        Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.extensions,
        Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.prototype
          .getExtension,
        a
      )
      a && (f.$jspbMessageInstance = b)
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData()
      a.productCorrelationId &&
        S(
          b,
          2,
...
Y.moneta.integrator.ui.buyflow.FundsGuaranteeCallbackData.serializeBinaryToWriter =
  function (a, b) {
    var c = a.getProductCorrelationId()
    null != c &&
      J(
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.PurchaseOrderId.prototype.toObject = function (
    a
  ) {
...
Y.moneta.integrator.common.purchaseorder.Chargeback = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.purchaseorder.Chargeback.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.Chargeback.prototype.toObject =
    function (a) {
  ...
  (Y.moneta.integrator.common.purchaseorder.Chargeback.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.Chargeback.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.Chargeback.fromObject = function (
    a
  ) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItemEvent.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.LineItemEvent.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.LineItemEvent.toObject = function (
    a,
    b
  ) {
    var c,
      f = {
        ...
        cancel:
          ...
          Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.toObject(
            a,
            c
          ),
        refund:
          ...
          Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.toObject(
            a,
            c
          ),
      }
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItemEvent.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.LineItemEvent.fromObject =
    function (a) {
      ...
      a.cancel &&
        S(
          b,
          2,
          Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.fromObject(
            a.cancel
          )
        )
      a.refund &&
        S(
          b,
          3,
          Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.fromObject(
            a.refund
          )
        )
      return b
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.fromObject =
    function (a) {
      var b =
...
Y.moneta.integrator.common.purchaseorder.LineItemEvent.Cancel.deserializeBinary =
  function (a) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.fromObject =
    function (a) {
      var b =
...
Y.moneta.integrator.common.purchaseorder.LineItemEvent.Refund.deserializeBinary =
  function (a) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.PriceDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.PriceDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.PriceDetails.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.PriceDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.PriceDetails.fromObject = function (
    a
  ) {
...
Y.moneta.integrator.common.purchaseorder.PriceDetails.prototype.setPretaxAmount =
  function (a) {
    S(this, 1, a)
  }
...
Y.moneta.integrator.common.Frequency.deserializeBinaryFromReader = function (
  a,
  b
) {
  for (; F(b) && !D(b); )
...
L.GENERATE_TO_OBJECT &&
  ...
  (Y.moneta.integrator.common.subscription.SubscriptionFreeTrialDuration.toObject =
    function (a, b) {
      var c,
        f = {
          count: null == (c = O(b, 1)) ? void 0 : c,
...
Y.moneta.integrator.common.subscription.SubscriptionFreeTrialDuration.deserializeBinary =
  function (a) {
...
Y.moneta.integrator.common.subscription.SubscriptionFreeTrialDuration.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.common.subscription.SubscriptionFreeTrialDuration,
      a
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.InitiatingDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.InitiatingDetails.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.InitiatingDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.InitiatingDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.purchaseorder.InitiatingDetails()
      a.frequency &&
        S(b, 1, Y.moneta.integrator.common.Frequency.fromObject(a.frequency))
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        case 1:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.Frequency.deserializeBinaryFromReader
          )
          S(a, 1, c)
          break
        case 2:
        ...
        case 3:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.subscription
              .SubscriptionFreeTrialDuration.deserializeBinaryFromReader
          )
          S(a, 3, c)
          break
        default:
...
Y.moneta.integrator.common.purchaseorder.InitiatingDetails.serializeBinaryToWriter =
  function (a, b) {
    var c = Q(a, Y.moneta.integrator.common.Frequency, 1)
    null != c &&
      J(b, 1, c, Y.moneta.integrator.common.Frequency.serializeBinaryToWriter)
    c = O(a, 2)
    null != c && b.writeInt64(2, c)
    c = Q(
      a,
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.SubscriptionDetails.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.SubscriptionDetails.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.SubscriptionDetails.toObject =
    function (a, b) {
      var c,
        f = {
          subscriptionId:
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.SubscriptionDetails.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.SubscriptionDetails.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.common.purchaseorder.SubscriptionDetails()
      a.subscriptionId &&
        S(
          b,
          1,
      ...
      null != a.subscriptionPurchaseOrderType &&
        P(b, 2, a.subscriptionPurchaseOrderType)
      a.initiatingDetails &&
        S(
          b,
          3,
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.ServicePeriod.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.ServicePeriod.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.ServicePeriod.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.ServicePeriod.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.ServicePeriod.fromObject =
    function (a) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.UnitLevelState.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.UnitLevelState.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.UnitLevelState.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.UnitLevelState.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.UnitLevelState.fromObject =
    function (a) {
      ...
      a.priceDetails &&
        S(
          b,
          2,
          Y.moneta.integrator.common.purchaseorder.PriceDetails.fromObject(
            a.priceDetails
          )
        )
      a.servicePeriod &&
...
Y.moneta.integrator.common.purchaseorder.UnitLevelState.serializeBinaryToWriter =
  function (a, b) {
    var c = O(a, 1)
    null != c && b.writeInt32(1, c)
    c = a.getPriceDetails()
...
Y.moneta.integrator.common.purchaseorder.UnitLevelState.prototype.getPriceDetails =
  function () {
    return Q(this, Y.moneta.integrator.common.purchaseorder.PriceDetails, 2)
  }
Y.moneta.integrator.common.purchaseorder.UnitLevelState.prototype.setPriceDetails =
  function (a) {
    S(this, 2, a)
  }
...
Y.moneta.integrator.common.purchaseorder.LineItem = function (a) {
  M(
    ...
    a,
    -1,
    Y.moneta.integrator.common.purchaseorder.LineItem.repeatedFields_,
    null
  )
}
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItem.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.LineItem.toObject(a, this)
    }),
  (Y.moneta.integrator.common.purchaseorder.LineItem.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.LineItem.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.LineItem.fromObject = function (a) {
    ...
    null != a.lastModifiedTimeMillis && P(b, 3, a.lastModifiedTimeMillis)
    a.lineItemEventList &&
      V(
        b,
        4,
        a.lineItemEventList.map(
          Y.moneta.integrator.common.purchaseorder.LineItemEvent.fromObject
        )
      )
    null != a.stockKeepingUnit && P(b, 5, a.stockKeepingUnit)
    null != a.purchaseProcessingState && P(b, 6, a.purchaseProcessingState)
...
Y.moneta.integrator.common.purchaseorder.LineItem.serializeBinaryToWriter =
  function (a, b) {
    ...
    c = a.getAmount()
    null != c &&
      J(b, 7, c, Y.moneta.integrator.common.Amount.serializeBinaryToWriter)
    c = O(a, 19)
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.PlayOrderId.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.PlayOrderId.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.PlayOrderId.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.PlayOrderId.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.PlayOrderId.fromObject = function (
    a
  ) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.PurchaseOrder.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.common.purchaseorder.PurchaseOrder.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.common.purchaseorder.PurchaseOrder.toObject = function (
    a,
    b
  ) {
    var c,
      f = {
        purchaseOrderId:
          (c = Lc(b)) &&
          Y.moneta.integrator.common.PurchaseOrderId.toObject(a, c),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.common.purchaseorder.PurchaseOrder.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.common.purchaseorder.PurchaseOrder.fromObject =
    function (a) {
      ...
      a.purchaseOrderId &&
        S(
          b,
          1,
          Y.moneta.integrator.common.PurchaseOrderId.fromObject(
            a.purchaseOrderId
          )
        )
      ...
      a.lineItemList &&
        V(
          ...
          6,
          a.lineItemList.map(
            Y.moneta.integrator.common.purchaseorder.LineItem.fromObject
          )
        )
      null != a.externalPurchaseOrderId && P(b, 7, a.externalPurchaseOrderId)
      a.chargebackList &&
        V(
          b,
          8,
          a.chargebackList.map(
            Y.moneta.integrator.common.purchaseorder.Chargeback.fromObject
          )
        )
      null != a.additionalFundingSourceUsed &&
        P(b, 9, a.additionalFundingSourceUsed)
      a.playOrderId &&
        S(
          b,
          10,
          Y.moneta.integrator.common.purchaseorder.PlayOrderId.fromObject(
            a.playOrderId
          )
        )
      return b
    ...
    for (; F(b) && !D(b); )
      switch (b.getFieldNumber()) {
        ...
        case 6:
          ...
          b.readMessage(
            c,
            Y.moneta.integrator.common.purchaseorder.LineItem
              .deserializeBinaryFromReader
          )
  ...
  function (a, b) {
    ...
    null != c &&
      J(
        ...
        1,
        c,
        Y.moneta.integrator.common.PurchaseOrderId.serializeBinaryToWriter
      )
    c = O(a, 2)
    null != c && b.writeInt64(2, c)
    c = O(a, 5)
...
Y.moneta.integrator.common.purchaseorder.PurchaseOrder.prototype.setPurchaseOrderId =
  function (a) {
    S(this, 1, a)
  }
Y.moneta.integrator.common.purchaseorder.PurchaseOrder.prototype.setCreationTimeMillis =
  function (a) {
    P(this, 2, a)
  }
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.ui.buyflow.PurchaseApprovalInfo.prototype.toObject =
    function (a) {
  ...
  (Y.moneta.integrator.ui.buyflow.PurchaseApprovalInfo.toObject = function (
    a,
    b
  ) {
    var c,
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.ui.buyflow.PurchaseApprovalInfo.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.ui.buyflow.PurchaseApprovalInfo.fromObject = function (
    a
  ) {
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.ui.buyflow.ManagedPurchaseCallbackData.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.ui.buyflow.ManagedPurchaseCallbackData.toObject(
        a,
        this
      )
    }),
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.ui.buyflow.ManagedPurchaseCallbackData.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.ui.buyflow.ManagedPurchaseCallbackData.fromObject =
    function (a) {
      var b = new Y.moneta.integrator.ui.buyflow.ManagedPurchaseCallbackData()
      ...
      null != a.externalPurchaseOrderId && P(b, 3, a.externalPurchaseOrderId)
      a.purchaseOrder &&
        S(
          b,
          4,
      ...
      a.approvalInfo &&
        S(
          b,
          8,
          Y.moneta.integrator.ui.buyflow.PurchaseApprovalInfo.fromObject(
            a.approvalInfo
          )
        )
      null != a.integratorDisplayTitle && P(b, 9, a.integratorDisplayTitle)
      null != a.integratorDisplayMessage && P(b, 10, a.integratorDisplayMessage)
      a.selectedShippingDetails &&
        S(
          b,
          11,
...
L.GENERATE_TO_OBJECT &&
  ((Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.prototype.toObject =
    function (a) {
      return Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.toObject(
        a,
        this
      )
    }),
  (Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.toObject =
    function (a, b) {
      var c,
        f = {
          requestHeader:
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.fromObject =
    function (a) {
      var b =
...
Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.deserializeBinary =
  function (a) {
...
Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.serializeBinaryToWriter =
  function (a, b) {
    var c = Q(a, Y.moneta.integrator.callbacks.common.CallbackRequestHeader, 1)
    null != c &&
      J(
        b,
        1,
...
Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteRequest,
      a
...
L.GENERATE_TO_OBJECT &&
  ...
  (Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse.toObject =
    function (a, b) {
      var c,
        f = {
...
L.GENERATE_FROM_OBJECT &&
  ((Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse.ObjectFormat =
    function () {}),
  (Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse.fromObject =
    function (a) {
      var b =
        new Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse()
      null != a.status && P(b, 1, a.status)
      a.errorMessageHtml &&
        S(b, 2, Y.html.SafeHtmlProto.fromObject(a.errorMessageHtml))
...
Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse.deserializeBinary =
  function (a) {
  ...
  function (a, b) {
    ...
    null != c &&
      J(
        ...
        c,
        Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse
          .RetryOverride.serializeBinaryToWriter
      )
  }
...
Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse.deserialize =
  function (a) {
    return X(
      Y.moneta.integrator.callbacks.buyflowcomplete.BuyFlowCompleteResponse,
      a
...
var Qc = function (a) {
  ...
  chrome.app.runtime.onLaunched.addListener(
    k.bind(this.launchWindow_, this, null)
  )
}
...
k.dom.BrowserFeature.OFFSCREEN_CANVAS_2D =
  ...
  (k.dom.BrowserFeature.ASSUME_OFFSCREEN_CANVAS ||
    k.dom.BrowserFeature.detectOffscreenCanvas_())
...
k.dom.BrowserFeature.CAN_USE_INNER_TEXT =
  k.userAgent.IE && !k.userAgent.isVersionOrHigher("9")
...
k.dom.BrowserFeature.LEGACY_IE_RANGES =
  k.userAgent.IE && !k.userAgent.isDocumentModeOrHigher(9)
...
k.dom.COMPAT_MODE_KNOWN_ =
  k.dom.ASSUME_QUIRKS_MODE || k.dom.ASSUME_STANDARDS_MODE
k.dom.getDomHelper = function (a) {
  return a
    ? new k.dom.DomHelper(k.dom.getOwnerDocument(a))
    : k.dom.defaultDomHelper_ ||
        (k.dom.defaultDomHelper_ = new k.dom.DomHelper())
}
...
k.dom.getElementsByTagNameAndClass_ = function (a, b, c, f) {
  ...
  if (c && a.getElementsByClassName) {
    ...
    if (b) {
      f = {}
      for (var g = 0, h = 0, l; (l = a[h]); h++) b == l.nodeName && (f[g++] = l)
      f.length = g
      return f
    }
    return a
  ...
  if (c) {
    ...
    for (h = g = 0; (l = a[h]); h++)
      (b = l.className),
        "function" == typeof b.split && ua(b.split(/\s+/), c) && (f[g++] = l)
    f.length = g
    return f
  }
  return a
...
k.dom.getPageScroll = function (a) {
  return k.dom
    .getDomHelper((a || k.global || window).document)
    .getDocumentScroll()
}
...
k.dom.createDom_ = function (a, b) {
  ...
  2 < b.length && k.dom.append_(a, c, b, 2)
  return c
}
k.dom.append_ = function (a, b, c, f) {
  ...
  for (; f < c.length; f++) {
    var h = c[f]
    k.isArrayLike(h) && !k.dom.isNodeLike(h)
      ? n(k.dom.isNodeList(h) ? Da(h) : h, g)
      : g(h)
  }
}
...
k.dom.safeHtmlToNode_ = function (a, b) {
  ...
  k.dom.BrowserFeature.INNER_HTML_NEEDS_SCOPED_ELEMENT
    ? (k.dom.safe.setInnerHtml(
        c,
        k.html.SafeHtml.concat(k.html.SafeHtml.BR, b)
      ),
...
k.dom.isCss1CompatMode_ = function (a) {
  return k.dom.COMPAT_MODE_KNOWN_
    ? k.dom.ASSUME_STANDARDS_MODE
...
k.dom.findCommonAncestor = function (a) {
  ...
  var f = [],
    g = Infinity
  for (b = 0; b < c; b++) {
    for (var h = [], l = arguments[b]; l; ) h.unshift(l), (l = l.parentNode)
    f.push(h)
  ...
  for (b = 0; b < g; b++) {
    l = f[0][b]
    for (var r = 1; r < c; r++) if (l != f[r][b]) return h
    h = l
  }
  return h
}
...
k.dom.getOwnerDocument = function (a) {
  ...
  return a.nodeType == k.dom.NodeType.DOCUMENT
    ? a
...
k.dom.getFrameContentWindow = function (a) {
  try {
    return (
      a.contentWindow ||
      (a.contentDocument ? k.dom.getWindow(a.contentDocument) : null)
    )
  } catch (b) {}
  return null
}
...
k.dom.findNodes_ = function (a, b, c, f) {
  if (null != a)
    for (a = a.firstChild; a; ) {
      if ((b(a) && (c.push(a), f)) || k.dom.findNodes_(a, b, c, f)) return !0
      a = a.nextSibling
    }
  return !1
}
...
k.dom.isFocusable = function (a) {
  ...
  return (b = k.dom.nativelySupportsFocus_(a)
    ? !a.disabled &&
      (!k.dom.hasSpecifiedTabIndex_(a) || k.dom.isTabIndexFocusable_(a))
...
k.dom.hasNonZeroBoundingRect_ = function (a) {
  a =
    ...
    (k.userAgent.IE && null == a.parentElement)
      ? { height: a.offsetHeight, width: a.offsetWidth }
      : a.getBoundingClientRect()
  return null != a && 0 < a.height && 0 < a.width
}
k.dom.getTextContent = function (a) {
  if (k.dom.BrowserFeature.CAN_USE_INNER_TEXT && null !== a && "innerText" in a)
    a = k.string.canonicalizeNewlines(a.innerText)
  else {
    var b = []
...
k.dom.getNodeAtOffset = function (a, b, c) {
  ...
  k.isObject(c) &&
    ((c.remainder = g ? g.nodeValue.length + b - f - 1 : 0), (c.node = g))
  return g
}
  ...
  return k.dom.getAncestor(
    ...
    function (h) {
      return (
        (!g || h.nodeName == g) &&
        (!c ||
          ("string" === typeof h.className && ua(h.className.split(/\s+/), c)))
      )
    },
    !0,
    f
...
k.async.nextTick = function (a, b, c) {
  ...
  "function" === typeof k.global.setImmediate &&
  (c || k.async.nextTick.useSetImmediate_())
    ? k.global.setImmediate(f)
    : (k.async.nextTick.setImmediate_ ||
        (k.async.nextTick.setImmediate_ =
          k.async.nextTick.getSetImmediateEmulator_()),
...
k.async.nextTick.getSetImmediateEmulator_ = function () {
  ...
  "undefined" === typeof a &&
    ...
    (a = function () {
      ...
      g = k.bind(function (v) {
        if (("*" == r || v.origin == r) && v.data == l) this.port1.onmessage()
      }, this)
...
k.async.run.initializeRunner_ = function () {
  if (
    k.ASSUME_NATIVE_PROMISE ||
    (k.global.Promise && k.global.Promise.resolve)
  ) {
...
k.log.Level.createPredefinedLevelsCache_ = function () {
  ...
  for (var a = 0, b; (b = k.log.Level.PREDEFINED_LEVELS[a]); a++)
...
k.log.Level.getPredefinedLevel = function (a) {
  k.log.Level.predefinedLevelsCache_ ||
    k.log.Level.createPredefinedLevelsCache_()
...
k.log.LogRegistry.getInstance = function () {
  k.log.LogRegistry.instance_ ||
    (k.log.LogRegistry.instance_ = new k.log.LogRegistry())
...
k.log.getRootLogger = function () {
  return k.log.ENABLED
    ? cd(k.log.LogRegistry.getInstance(), k.log.ROOT_LOGGER_NAME).logger
    : null
}
k.log.addHandler = function (a, b) {
  k.log.ENABLED &&
    a &&
    cd(k.log.LogRegistry.getInstance(), a.getName()).handlers.push(b)
}
k.log.removeHandler = function (a, b) {
  return k.log.ENABLED &&
    a &&
    ((a = cd(k.log.LogRegistry.getInstance(), a.getName())),
    (b = a.handlers.indexOf(b)),
    -1 !== b)
...
k.log.setLevel = function (a, b) {
  k.log.ENABLED &&
    a &&
    (cd(k.log.LogRegistry.getInstance(), a.getName()).level = b)
}
...
k.log.isLoggable = function (a, b) {
  return k.log.ENABLED && a && b
    ? b.value >= k.log.getEffectiveLevel(a).value
    : !1
}
...
k.Promise = function (a, b) {
  ...
  this.executing_ = !1
  0 < k.Promise.UNHANDLED_REJECTION_DELAY
...
k.Promise.allSettled = function (a) {
  return new k.Promise(function (b) {
    ...
    if (c)
      for (
        var g = function (r, v, E) {
            c--
            f[r] = v
              ? { fulfilled: !0, value: E }
              : { fulfilled: !1, reason: E }
            0 == c && b(f)
          },
          h = 0,
          l;
        ...
        (l = a[h]),
          k.Promise.resolveThen_(l, k.partial(g, h, !0), k.partial(g, h, !1))
    else b(f)
  })
}
...
k.Promise.prototype.then = function (a, b, c) {
  null != a &&
    k.asserts.assertFunction(a, "opt_onFulfilled should be a function.")
  null != b &&
            ...
            (c.state_ == k.Promise.State_.PENDING && 1 == f
              ...
              : (h
                  ? ((f = h),
                    ...
                    f.next == c.callbackEntriesTail_ &&
                      (c.callbackEntriesTail_ = f),
                    (f.next = f.next.next))
                  : jd(c),
                kd(c, g, k.Promise.State_.REJECTED, b)))
        }
        a.parent_ = null
      } else fd(a, k.Promise.State_.REJECTED, b)
  },
  md = function (a, b) {
    a.callbackEntries_ ||
      (a.state_ != k.Promise.State_.FULFILLED &&
        a.state_ != k.Promise.State_.REJECTED) ||
      ld(a)
    ...
    g.child = new k.Promise(function (h, l) {
      ...
      g.onRejected = c
        ? function (r) {
            try {
              var v = c.call(f, r)
              void 0 === v && r instanceof k.Promise.CancellationError
                ? l(r)
                : h(v)
            } catch (E) {
              l(E)
...
k.Promise.maybeThen_ = function (a, b, c, f) {
  if (a instanceof k.Promise)
    return (
      null != b &&
        k.asserts.assertFunction(b, "opt_onFulfilled should be a function."),
      null != c &&
        k.asserts.assertFunction(
          c,
          "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"
  ...
  if (k.isObject(a))
    try {
      var g = a.then
      if ("function" === typeof g) return k.Promise.tryThen_(a, g, b, c, f), !0
    } catch (h) {
      return c.call(f, h), !0
    }
  return !1
...
k.Promise.prototype.executeCallbacks_ = function () {
  for (var a; (a = jd(this)); )
    k.Promise.LONG_STACK_TRACES && this.currentStep_++,
      kd(this, a, this.state_, this.result_)
  this.executing_ = !1
}
  ...
  if (c == k.Promise.State_.REJECTED && b.onRejected && !b.always)
    if (0 < k.Promise.UNHANDLED_REJECTION_DELAY)
      for (; a && a.unhandledRejectionId_; a = a.parent_)
        k.global.clearTimeout(a.unhandledRejectionId_),
  ...
  if (b.child) (b.child.parent_ = null), k.Promise.invokeCallback_(b, c, f)
    ...
    try {
      b.always
        ...
        : k.Promise.invokeCallback_(b, c, f)
    } catch (g) {
    ...
    : 0 == k.Promise.UNHANDLED_REJECTION_DELAY &&
      ...
      k.async.run(function () {
        a.hadUnhandledRejection_ &&
          (nd(a, b), k.Promise.handleRejection_.call(null, b))
      }))
}
...
d.tick_ = function () {
  if (this.enabled) {
    ...
    0 < a && a < this.interval_ * k.Timer.intervalScale
...
k.Timer.callOnce = function (a, b, c) {
  ...
  else if (a && "function" == typeof a.handleEvent) a = k.bind(a.handleEvent, a)
...
k.net.XhrIo.prototype.send = function (a, b, c, f) {
  ...
  this.progressEventsEnabled_ &&
    ...
    this.xhr_.upload &&
      (this.xhr_.upload.onprogress = k.bind(this.onProgressHandler_, this)))
  try {
      ...
      0 < this.timeoutInterval_ &&
        ...
        this.useXhr2Timeout_
          ? ((this.xhr_[k.net.XhrIo.XHR2_TIMEOUT_] = this.timeoutInterval_),
            (this.xhr_[k.net.XhrIo.XHR2_ON_TIMEOUT_] = k.bind(
              this.timeout_,
              this
            )))
          : (this.timeoutId_ = k.Timer.callOnce(
              this.timeout_,
              this.timeoutInterval_,
              this
            ))),
...
k.net.XhrIo.shouldUseXhr2Timeout_ = function (a) {
  return (
    k.userAgent.IE &&
    k.userAgent.isVersionOrHigher(9) &&
    "number" === typeof a[k.net.XhrIo.XHR2_TIMEOUT_] &&
    ...
    if (
      ...
      try {
        if (a.isSuccess())
          ...
          try {
            var b =
              td(a) > k.net.XmlHttp.ReadyState.LOADED ? a.xhr_.statusText : ""
          } catch (c) {
...
k.net.XhrIo.prototype.onProgressHandler_ = function (a, b) {
  ...
  this.dispatchEvent(
    k.net.XhrIo.buildProgressEvent_(a, k.net.EventType.PROGRESS)
  )
  this.dispatchEvent(
