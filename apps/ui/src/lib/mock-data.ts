...
export const MOCK_PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "20 template requests per month",
      "Unlimited projects",
      "Priority support",
      "Advanced filters",
    ],
...
export const MOCK_TEMPLATES: Template[] = [
  {
    ...
    description:
      "Modern shopping experience with product showcase, testimonials, and conversion-focused design.",
    longDescription:
  ...
  },
  {
    ...
    slug: "fashion-store",
    description:
      "Trendy clothing store template with product galleries, size guides, and checkout flow.",
    longDescription:
      "Perfect for fashion brands and boutiques. Features lookbook galleries, size charts, and integrated shopping cart functionality.",
    category: "E-commerce",
    planRequired: "solo",
    thumbnailUrl:
    ...
    previewImages: [
      ...
      "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1600&h=1000&fit=crop",
    ],
    downloadCount: 892,
    rating: 4.7,
  ...
  },
  {
    ...
    description:
      "Multi-vendor marketplace for digital products with seller dashboards and reviews.",
    longDescription:
      "Create your own digital goods marketplace. Supports multiple vendors, product reviews, and secure digital delivery.",
    category: "E-commerce",
    planRequired: "studio",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1517245386807-9b4d0d6e9d8a?w=1200&h=800&fit=crop",
    previewImages: [
      "https://images.unsplash.com/photo-1526738549149-8e07eca6c147?w=1600&h=1000&fit=crop",
    ],
    downloadCount: 1543,
    rating: 4.9,
    tags: ["marketplace", "digital", "vendors"],
    creator: "MarketPro",
    compatibility: ["Framer"],
  },
  {
    ...
    slug: "saas-dashboard",
    description:
      "Comprehensive analytics dashboard with charts, data tables, and user management panels.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Showcase your work with this elegant portfolio template featuring image galleries and case studies.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Food presentation template with image grids, pricing, and contact information for local restaurants.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Professional slide deck template with charts, timelines, and team collaboration tools.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Grid-based photography showcase with lightbox, categorization, and client testimonials.",
    longDescription:
  ...
  },
  {
    ...
    slug: "blog-magazine",
    description:
      "Multi-author blog platform with featured posts, categories, and social sharing functionality.",
    longDescription:
    ...
    planRequired: "solo",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1486312338219-ce68e2c6f44d?w=1200&h=800&fit=crop",
    previewImages: [
      "https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=1600&h=1000&fit=crop",
  ...
  },
  {
    ...
    slug: "tech-blog",
    description:
      "Modern tech blog with code highlighting, dark mode, and developer-friendly features.",
    longDescription:
      "Built for developers and tech writers. Features syntax highlighting, markdown support, and a clean reading experience.",
    category: "Blog",
    planRequired: "solo",
    thumbnailUrl:
      "https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=1200&h=800&fit=crop",
    previewImages: [
      "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1600&h=1000&fit=crop",
    ],
    downloadCount: 734,
    rating: 4.8,
  ...
  },
  {
    ...
    slug: "event-landing",
    description:
      "Time-sensitive marketing page for conferences and events with countdown timers and registration forms.",
    longDescription:
